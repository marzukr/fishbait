...
#ifndef SRC_BLUEPRINT_HYPERPARAMETERS_H_
#define SRC_BLUEPRINT_HYPERPARAMETERS_H_
...
const std::filesystem::path kSaveDir = "out/blueprint/run_1";
...
#endif  // SRC_BLUEPRINT_HYPERPARAMETERS_H_
