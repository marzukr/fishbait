...
inline void ShowdownLUT_File(FileAction action,
                             ...
                             bool verbose = false) {
  Cereal(action, "out/hand_strengths/showdown_lut_vector.cereal", data_points,
         verbose);
}
...
inline void PreflopLUT_File(FileAction action,
                            ...
                            bool verbose = false) {
  Cereal(action, "out/hand_strengths/preflop_lut_nda.cereal", data_points,
         verbose);
}
...
inline void FlopLUT_File(FileAction action,
                         nda::matrix<HistCount>* data_points,
                         bool verbose = false) {
  Cereal(action, "out/hand_strengths/flop_lut_nda.cereal", data_points,
         verbose);
}
...
inline void TurnLUT_File(FileAction action,
                         nda::matrix<HistCount>* data_points,
                         bool verbose = false) {
  Cereal(action, "out/hand_strengths/turn_lut_nda.cereal", data_points,
         verbose);
}
...
inline void RiverLUT_File(FileAction action,
                          ...
                          bool verbose = false) {
  Cereal(action, "out/hand_strengths/river_lut_nda.cereal", data_points,
         verbose);
}
...
inline void OCHS_PreflopLUT_File(FileAction action,
                                 nda::matrix<double>* data_points,
                                 bool verbose = false) {
  Cereal(action, "out/hand_strengths/ochs_preflop_lut_nda.cereal", data_points,
         verbose);
}
