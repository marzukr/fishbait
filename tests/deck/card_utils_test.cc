...
TEST_CASE("Test SK to ISO", "[deck][cardutils]") {
  ...
  std::array<uint8_t, deck::kDeckSize> correct{48, 49, 50, 51, 44, 45, 46, 47,
      40, 41, 42, 43, 36, 37, 38, 39, 32, 33, 34, 35, 28, 29, 30, 31, 24, 25,
      26, 27, 20, 21, 22, 23, 16, 17, 18, 19, 12, 13, 14, 15,  8,  9, 10, 11, 4,
      5,  6,  7,  0,  1,  2,  3};
