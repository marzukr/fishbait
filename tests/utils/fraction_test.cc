...
TEST_CASE("int8_t plus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{2586872, 8422255};
  f0 = int8_t{52} + f0;
  REQUIRE(f0.numerator() == 440544132);
  REQUIRE(f0.denominator() == 8422255);
  // positive negative
  utils::Fraction f1{-6955329, 7406468};
  f1 = int8_t{86} + f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{1124980, 444171};
  f3 = int8_t{-23} + f3;
  REQUIRE(f3.numerator() == -9090953);
  REQUIRE(f3.denominator() == 444171);
  // negative negative
  utils::Fraction f4{-2090908, 2471217};
  f4 = int8_t{-98} + f4;
  ...
  // 0 positive
  utils::Fraction f6{7147770, 1973837};
  f6 = int8_t{0} + f6;
  REQUIRE(f6.numerator() == 7147770);
  REQUIRE(f6.denominator() == 1973837);
  // 0 negative
  utils::Fraction f7{-172222, 150147};
  f7 = int8_t{0} + f7;
...
TEST_CASE("uint8_t plus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{196391, 5137656};
  f0 = uint8_t{220} + f0;
  REQUIRE(f0.numerator() == 1130480711);
  REQUIRE(f0.denominator() == 5137656);
  // positive negative
  utils::Fraction f1{-204083, 128125};
  f1 = uint8_t{10} + f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{7744077, 1737107};
  f3 = uint8_t{0} + f3;
  REQUIRE(f3.numerator() == 7744077);
  REQUIRE(f3.denominator() == 1737107);
  // 0 negative
  utils::Fraction f4{-5828007, 5909818};
  f4 = uint8_t{0} + f4;
...
TEST_CASE("int16_t plus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{3021589, 491358};
  f0 = int16_t{14477} + f0;
  REQUIRE(f0.numerator() == 7116411355);
  REQUIRE(f0.denominator() == 491358);
  // positive negative
  utils::Fraction f1{-163157, 754237};
  f1 = int16_t{6144} + f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{2361319, 9938191};
  f3 = int16_t{-27007} + f3;
  REQUIRE(f3.numerator() == -268398363018);
  REQUIRE(f3.denominator() == 9938191);
  // negative negative
  utils::Fraction f4{-669053, 810925};
  f4 = int16_t{-27953} + f4;
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{6247222, 7180587};
  f6 = int16_t{0} + f6;
  REQUIRE(f6.numerator() == 6247222);
  REQUIRE(f6.denominator() == 7180587);
  // 0 negative
  utils::Fraction f7{-1433549, 1569546};
  f7 = int16_t{0} + f7;
...
TEST_CASE("uint16_t plus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{9402754, 8402683};
  f3 = uint16_t{0} + f3;
  REQUIRE(f3.numerator() == 9402754);
  REQUIRE(f3.denominator() == 8402683);
  // 0 negative
  utils::Fraction f4{-2873463, 3474514};
  f4 = uint16_t{0} + f4;
...
TEST_CASE("int32_t plus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{1647215, 8553912};
  f6 = int32_t{0} + f6;
  REQUIRE(f6.numerator() == 1647215);
  REQUIRE(f6.denominator() == 8553912);
  // 0 negative
  utils::Fraction f7{-946638, 3035629};
  f7 = int32_t{0} + f7;
...
TEST_CASE("uint32_t plus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{9357610, 3530111};
  f3 = uint32_t{0} + f3;
  REQUIRE(f3.numerator() == 9357610);
  REQUIRE(f3.denominator() == 3530111);
  // 0 negative
  utils::Fraction f4{-8967053, 2107827};
  f4 = uint32_t{0} + f4;
...
TEST_CASE("int64_t plus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{444568, 1203411};
  f6 = int64_t{0} + f6;
  REQUIRE(f6.numerator() == 444568);
  REQUIRE(f6.denominator() == 1203411);
  // 0 negative
  utils::Fraction f7{-1800520, 4254429};
  f7 = int64_t{0} + f7;
...
TEST_CASE("fraction plus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0 =
      utils::Fraction{4460803, 3974972} + utils::Fraction{9462287, 9721515};
  REQUIRE(f0.numerator() == 80978089157509);
  REQUIRE(f0.denominator() == 38642749922580);
  // positive negative
  utils::Fraction f1 =
      utils::Fraction{1339988, 2206125} + utils::Fraction{-141165, 538378};
  REQUIRE(f1.numerator() == 409992423839);
  REQUIRE(f1.denominator() == 1187729165250);
  // positive 0
  utils::Fraction f2 = utils::Fraction{646554, 429037} + utils::Fraction{0, 1};
  REQUIRE(f2.numerator() == 646554);
  REQUIRE(f2.denominator() == 429037);
  // negative positive
  utils::Fraction f3 =
      utils::Fraction{-1853114, 1414099} + utils::Fraction{6913815, 2000107};
  REQUIRE(f3.numerator() == 6070392594487);
  REQUIRE(f3.denominator() == 2828349308593);
  // negative negative
  utils::Fraction f4 =
      utils::Fraction{-2375461, 2719709} + utils::Fraction{-4440429, 3589049};
  REQUIRE(f4.numerator() == -20602320641750);
  REQUIRE(f4.denominator() == 9761168866741);
  // negative 0
  utils::Fraction f5 =
      utils::Fraction{-3956936, 5982621} + utils::Fraction{0, 1};
  REQUIRE(f5.numerator() == -3956936);
  REQUIRE(f5.denominator() == 5982621);
  // 0 positive
  utils::Fraction f6 =
      utils::Fraction{0, 1} + utils::Fraction{4376117, 7998591};
  REQUIRE(f6.numerator() == 4376117);
  REQUIRE(f6.denominator() == 7998591);
  // 0 negative
  utils::Fraction f7 =
      utils::Fraction{0, 1} + utils::Fraction{-1268635, 1266482};
...
TEST_CASE("int8_t minus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{1832879, 7252952};
  f0 = int8_t{101} - f0;
  REQUIRE(f0.numerator() == 730715273);
  REQUIRE(f0.denominator() == 7252952);
  // positive negative
  utils::Fraction f1{-1556441, 3981341};
  f1 = int8_t{70} - f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{1076042, 933707};
  f3 = int8_t{-80} - f3;
  REQUIRE(f3.numerator() == -75772602);
  REQUIRE(f3.denominator() == 933707);
  // negative negative
  utils::Fraction f4{-5538257, 5349881};
  f4 = int8_t{-118} - f4;
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{430693, 8939732};
  f6 = int8_t{0} - f6;
  REQUIRE(f6.numerator() == -430693);
  REQUIRE(f6.denominator() == 8939732);
  // 0 negative
  utils::Fraction f7{-7204183, 7240336};
  f7 = int8_t{0} - f7;
...
TEST_CASE("uint8_t minus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{385858, 658463};
  f0 = uint8_t{135} - f0;
  REQUIRE(f0.numerator() == 88506647);
  REQUIRE(f0.denominator() == 658463);
  // positive negative
  utils::Fraction f1{-843757, 792310};
  f1 = uint8_t{172} - f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{70279, 1749179};
  f3 = uint8_t{0} - f3;
  REQUIRE(f3.numerator() == -70279);
  REQUIRE(f3.denominator() == 1749179);
  // 0 negative
  utils::Fraction f4{-9678171, 4186867};
  f4 = uint8_t{0} - f4;
...
TEST_CASE("int16_t minus fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{5151173, 1901601};
  f0 = int16_t{19212} - f0;
  REQUIRE(f0.numerator() == 36528407239);
  REQUIRE(f0.denominator() == 1901601);
  // positive negative
  utils::Fraction f1{-536182, 4697303};
  f1 = int16_t{3137} - f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{2853197, 6509520};
  f3 = int16_t{-22971} - f3;
  REQUIRE(f3.numerator() == -149533037117);
  REQUIRE(f3.denominator() == 6509520);
  // negative negative
  utils::Fraction f4{-3633106, 8172363};
  f4 = int16_t{-13688} - f4;
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{2569032, 105485};
  f6 = int16_t{0} - f6;
  REQUIRE(f6.numerator() == -2569032);
  REQUIRE(f6.denominator() == 105485);
  // 0 negative
  utils::Fraction f7{-2486137, 4698668};
  f7 = int16_t{0} - f7;
...
TEST_CASE("uint16_t minus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{641399, 9873458};
  f3 = uint16_t{0} - f3;
  REQUIRE(f3.numerator() == -641399);
  REQUIRE(f3.denominator() == 9873458);
  // 0 negative
  utils::Fraction f4{-1372233, 2828771};
  f4 = uint16_t{0} - f4;
...
TEST_CASE("int32_t minus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{4017683, 9318527};
  f6 = int32_t{0} - f6;
  REQUIRE(f6.numerator() == -4017683);
  REQUIRE(f6.denominator() == 9318527);
  // 0 negative
  utils::Fraction f7{-1460674, 520439};
  f7 = int32_t{0} - f7;
...
TEST_CASE("uint32_t minus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{2923561, 3276818};
  f3 = uint32_t{0} - f3;
  REQUIRE(f3.numerator() == -2923561);
  REQUIRE(f3.denominator() == 3276818);
  // 0 negative
  utils::Fraction f4{-8837053, 7009602};
  f4 = uint32_t{0} - f4;
...
TEST_CASE("int64_t minus fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{4352452, 5535121};
  f6 = int64_t{0} - f6;
  REQUIRE(f6.numerator() == -4352452);
  REQUIRE(f6.denominator() == 5535121);
  // 0 negative
  utils::Fraction f7{-28945, 52919};
  f7 = int64_t{0} - f7;
...
TEST_CASE("fraction multiply equals fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{3486785, 7485456};
  f0 *= utils::Fraction{1647097, 361347};
  REQUIRE(f0.numerator() == 5743073113145);
  REQUIRE(f0.denominator() == 2704847069232);
  // positive negative
  utils::Fraction f1{4872031, 1545821};
  f1 *= utils::Fraction{-2087705, 4346904};
  REQUIRE(f1.numerator() == -10171363478855);
  REQUIRE(f1.denominator() == 6719535488184);
  // positive 0
  utils::Fraction f2{8287069, 4656112};
  f2 *= utils::Fraction{0, 1};
  REQUIRE(f2.numerator() == 0);
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{-5202585, 4817539};
  f3 *= utils::Fraction{9476753, 1504934};
  REQUIRE(f3.numerator() == -49303613006505);
  REQUIRE(f3.denominator() == 7250078237426);
  // negative negative
  utils::Fraction f4{-19691, 2984};
  f4 *= utils::Fraction{-3910069, 2662511};
  REQUIRE(f4.numerator() == 76993168679);
  REQUIRE(f4.denominator() == 7944932824);
  // negative 0
  utils::Fraction f5{-498661, 76359};
  f5 *= utils::Fraction{0, 1};
  REQUIRE(f5.numerator() == 0);
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{0, 1};
  f6 *= utils::Fraction{5856247, 7750330};
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7{0, 1};
  f7 *= utils::Fraction{-545398, 483673};
...
TEST_CASE("int8_t multiply fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{7887713, 3393490};
  f0 = int8_t{124} * f0;
  REQUIRE(f0.numerator() == 489038206);
  REQUIRE(f0.denominator() == 1696745);
  // positive negative
  utils::Fraction f1{-4085519, 1566460};
  f1 = int8_t{47} * f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{4622874, 855371};
  f3 = int8_t{-66} * f3;
  REQUIRE(f3.numerator() == -27737244);
  REQUIRE(f3.denominator() == 77761);
  // negative negative
  utils::Fraction f4{-3759591, 5705288};
  f4 = int8_t{-77} * f4;
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{3440501, 4963202};
  f6 = int8_t{0} * f6;
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7{-1400405, 1335181};
  f7 = int8_t{0} * f7;
  REQUIRE(f7.numerator() == 0);
  REQUIRE(f7.denominator() == 1);
  // 0 0
...
TEST_CASE("fraction multiply equals uint8_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{3752871, 5311798};
  f0 *= uint8_t{237};
  REQUIRE(f0.numerator() == 889430427);
  REQUIRE(f0.denominator() == 5311798);
  // positive 0
  utils::Fraction f1{5059323, 9283876};
  f1 *= uint8_t{0};
  REQUIRE(f1.numerator() == 0);
  REQUIRE(f1.denominator() == 1);
  // negative positive
  utils::Fraction f2{-706131, 423907};
  f2 *= uint8_t{93};
  REQUIRE(f2.numerator() == -65670183);
  REQUIRE(f2.denominator() == 423907);
  // negative 0
  utils::Fraction f3{-2464834, 6674901};
  f3 *= uint8_t{0};
...
TEST_CASE("uint8_t multiply fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{2127776, 2085997};
  f0 = uint8_t{236} * f0;
  REQUIRE(f0.numerator() == 502155136);
  REQUIRE(f0.denominator() == 2085997);
  // positive negative
  utils::Fraction f1{-1712765, 603636};
  f1 = uint8_t{160} * f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{618227, 8241};
  f3 = uint8_t{0} * f3;
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 negative
  utils::Fraction f4{-510011, 3643799};
  f4 = uint8_t{0} * f4;
  REQUIRE(f4.numerator() == 0);
  REQUIRE(f4.denominator() == 1);
  // 0 0
...
TEST_CASE("fraction multiply uint8_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{3131620, 4494323};
  f0 = f0 * uint8_t{172};
  REQUIRE(f0.numerator() == 538638640);
  REQUIRE(f0.denominator() == 4494323);
  // positive 0
  utils::Fraction f1{944137, 846221};
  f1 = f1 * uint8_t{0};
  REQUIRE(f1.numerator() == 0);
  REQUIRE(f1.denominator() == 1);
  // negative positive
  utils::Fraction f2{-2034282, 2372687};
  f2 = f2 * uint8_t{148};
  REQUIRE(f2.numerator() == -301073736);
  REQUIRE(f2.denominator() == 2372687);
  // negative 0
  utils::Fraction f3{-745465, 7374636};
  f3 = f3 * uint8_t{0};
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 positive
...
TEST_CASE("int16_t multiply fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{2884941, 279304};
  f0 = int16_t{22685} * f0;
  REQUIRE(f0.numerator() == 65444886585);
  REQUIRE(f0.denominator() == 279304);
  // positive negative
  utils::Fraction f1{-3518833, 135189};
  f1 = int16_t{6477} * f1;
  ...
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3{3938291, 9211050};
  f3 = int16_t{-32308} * f3;
  REQUIRE(f3.numerator() == -63619152814);
  REQUIRE(f3.denominator() == 4605525);
  // negative negative
  utils::Fraction f4{-95275, 69191};
  f4 = int16_t{-4247} * f4;
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{704775, 134404};
  f6 = int16_t{0} * f6;
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7{-4075742, 3680533};
  f7 = int16_t{0} * f7;
  REQUIRE(f7.numerator() == 0);
  REQUIRE(f7.denominator() == 1);
  // 0 0
...
TEST_CASE("fraction multiply equals uint16_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{555463, 1428684};
  f0 *= uint16_t{36806};
  REQUIRE(f0.numerator() == 10222185589);
  REQUIRE(f0.denominator() == 714342);
  // positive 0
  utils::Fraction f1{9038593, 9066408};
  f1 *= uint16_t{0};
  REQUIRE(f1.numerator() == 0);
  REQUIRE(f1.denominator() == 1);
  // negative positive
  utils::Fraction f2{-9102307, 5563281};
  f2 *= uint16_t{40271};
  REQUIRE(f2.numerator() == -366559005197);
  REQUIRE(f2.denominator() == 5563281);
  // negative 0
  utils::Fraction f3{-3841837, 2385467};
  f3 *= uint16_t{0};
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 positive
...
TEST_CASE("uint16_t multiply fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{2039209, 3015148};
  f3 = uint16_t{0} * f3;
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 negative
  utils::Fraction f4{-196123, 217299};
  f4 = uint16_t{0} * f4;
  REQUIRE(f4.numerator() == 0);
  REQUIRE(f4.denominator() == 1);
  // 0 0
...
TEST_CASE("int32_t multiply fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{3806464, 3314335};
  f6 = int32_t{0} * f6;
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7{-3049801, 9394146};
  f7 = int32_t{0} * f7;
  REQUIRE(f7.numerator() == 0);
  REQUIRE(f7.denominator() == 1);
  // 0 0
...
TEST_CASE("fraction multiply equals uint32_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{3246991, 1094067};
  f0 *= uint32_t{3961344};
  REQUIRE(f0.numerator() == 4287482771968);
  REQUIRE(f0.denominator() == 364689);
  // positive 0
  utils::Fraction f1{9606886, 5422173};
  f1 *= uint32_t{0};
  REQUIRE(f1.numerator() == 0);
  REQUIRE(f1.denominator() == 1);
  // negative positive
  utils::Fraction f2{-1415641, 1876965};
  f2 *= uint32_t{5200343};
  REQUIRE(f2.numerator() == -7361818764863);
  REQUIRE(f2.denominator() == 1876965);
  // negative 0
  utils::Fraction f3{-6976018, 346567};
  f3 *= uint32_t{0};
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 positive
...
TEST_CASE("uint32_t multiply fraction", "[utils][fraction]") {
  ...
  REQUIRE(f2.denominator() == 1);
  // 0 positive
  utils::Fraction f3{2633008, 3468565};
  f3 = uint32_t{0} * f3;
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
  // 0 negative
  utils::Fraction f4{-6141397, 6481466};
  f4 = uint32_t{0} * f4;
  REQUIRE(f4.numerator() == 0);
  REQUIRE(f4.denominator() == 1);
  // 0 0
...
TEST_CASE("int64_t multiply fraction", "[utils][fraction]") {
  ...
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6{49982, 99669};
  f6 = int64_t{0} * f6;
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7{-4370053, 3939005};
  f7 = int64_t{0} * f7;
  REQUIRE(f7.numerator() == 0);
  REQUIRE(f7.denominator() == 1);
  // 0 0
...
TEST_CASE("fraction multiply fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0 =
      utils::Fraction{9240540, 3001133} * utils::Fraction{3532022, 7650105};
  REQUIRE(f0.numerator() == 2175852704792);
  REQUIRE(f0.denominator() == 1530598837931);
  // positive negative
  utils::Fraction f1 =
      utils::Fraction{1957031, 6194303} * utils::Fraction{-1572570, 1593221};
  REQUIRE(f1.numerator() == -3077568239670);
  REQUIRE(f1.denominator() == 9868893619963);
  // positive 0
  utils::Fraction f2 =
      utils::Fraction{3756151, 7379219} * utils::Fraction{0, 1};
  REQUIRE(f2.numerator() == 0);
  REQUIRE(f2.denominator() == 1);
  // negative positive
  utils::Fraction f3 =
      utils::Fraction{-3347493, 2051467} * utils::Fraction{1542449, 6516388};
  REQUIRE(f3.numerator() == -5163337230357);
  REQUIRE(f3.denominator() == 13368154941196);
  // negative negative
  utils::Fraction f4 =
      utils::Fraction{-393047, 196573} * utils::Fraction{-377308, 1065005};
  REQUIRE(f4.numerator() == 148299777476);
  REQUIRE(f4.denominator() == 209351227865);
  // negative 0
  utils::Fraction f5 =
      utils::Fraction{-1730885, 5574321} * utils::Fraction{0, 1};
  REQUIRE(f5.numerator() == 0);
  REQUIRE(f5.denominator() == 1);
  // 0 positive
  utils::Fraction f6 =
      utils::Fraction{0, 1} * utils::Fraction{8340595, 3040052};
  REQUIRE(f6.numerator() == 0);
  REQUIRE(f6.denominator() == 1);
  // 0 negative
  utils::Fraction f7 =
      utils::Fraction{0, 1} * utils::Fraction{-9123783, 2884922};
  REQUIRE(f7.numerator() == 0);
  REQUIRE(f7.denominator() == 1);
  // 0 0
  utils::Fraction f8 = utils::Fraction{0, 1} * utils::Fraction{0, 1};
...
TEST_CASE("fraction divide equals fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{1273717, 988789};
  f0 /= utils::Fraction{9561909, 8690237};
  REQUIRE(f0.numerator() == 11068902600929);
  REQUIRE(f0.denominator() == 9454710438201);
  // positive negative
  utils::Fraction f1{45988, 6860369};
  f1 /= utils::Fraction{-4986491, 4328380};
  REQUIRE(f1.numerator() == -199053539440);
  REQUIRE(f1.denominator() == 34209168275179);
  // negative positive
  utils::Fraction f2{-284248, 4507873};
  f2 /= utils::Fraction{2613537, 3720287};
  REQUIRE(f2.numerator() == -1057484139176);
  REQUIRE(f2.denominator() == 11781492876801);
  // negative negative
  utils::Fraction f3{-5500578, 9610199};
  f3 /= utils::Fraction{-8717313, 8970551};
  REQUIRE(f3.numerator() == 16447738492826);
  REQUIRE(f3.denominator() == 27925037558429);
  // 0 positive
  utils::Fraction f4{0, 1};
  f4 /= utils::Fraction{8137596, 7724083};
  REQUIRE(f4.numerator() == 0);
  REQUIRE(f4.denominator() == 1);
  // 0 negative
  utils::Fraction f5{0, 1};
  f5 /= utils::Fraction{-4925405, 3648622};
  REQUIRE(f5.numerator() == 0);
  REQUIRE(f5.denominator() == 1);
...
TEST_CASE("fraction divide equals uint8_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{1914359, 696782};
  f0 /= uint8_t{234};
  REQUIRE(f0.numerator() == 1914359);
  REQUIRE(f0.denominator() == 163046988);
  // negative positive
  utils::Fraction f1{-669153, 464188};
  f1 /= uint8_t{151};
...
TEST_CASE("uint8_t divide fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{1740672, 1703245};
  f0 = uint8_t{79} / f0;
  REQUIRE(f0.numerator() == 134556355);
  REQUIRE(f0.denominator() == 1740672);
  // positive negative
  utils::Fraction f1{-4389568, 3681023};
  f1 = uint8_t{91} / f1;
  REQUIRE(f1.numerator() == -334973093);
  REQUIRE(f1.denominator() == 4389568);
  // 0 positive
  utils::Fraction f2{4938827, 23361};
  f2 = uint8_t{0} / f2;
  REQUIRE(f2.numerator() == 0);
  REQUIRE(f2.denominator() == 1);
  // 0 negative
  utils::Fraction f3{-2951757, 1303307};
  f3 = uint8_t{0} / f3;
  REQUIRE(f3.numerator() == 0);
  REQUIRE(f3.denominator() == 1);
...
TEST_CASE("fraction divide uint8_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{1310149, 123177};
  f0 = f0 / uint8_t{242};
  REQUIRE(f0.numerator() == 1310149);
  REQUIRE(f0.denominator() == 29808834);
  // negative positive
  utils::Fraction f1{-6140100, 3123769};
  f1 = f1 / uint8_t{176};
...
TEST_CASE("fraction divide equals uint16_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{7310880, 7876873};
  f0 /= uint16_t{45923};
  REQUIRE(f0.numerator() == 7310880);
  REQUIRE(f0.denominator() == 361729638779);
  // negative positive
  utils::Fraction f1{-5231105, 5256978};
  f1 /= uint16_t{39829};
...
TEST_CASE("fraction divide equals uint32_t", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0{847499, 8707120};
  f0 /= uint32_t{7206775};
  REQUIRE(f0.numerator() == 847499);
  REQUIRE(f0.denominator() == 62750254738000);
  // negative positive
  utils::Fraction f1{-7995121, 9213523};
  f1 /= uint32_t{6514383};
...
TEST_CASE("fraction divide fraction", "[utils][fraction]") {
  // positive positive
  utils::Fraction f0 =
      utils::Fraction{251619, 7538764} / utils::Fraction{663527, 1585043};
  REQUIRE(f0.numerator() == 398826934617);
  REQUIRE(f0.denominator() == 5002173460628);
  // positive negative
  utils::Fraction f1 =
      utils::Fraction{6278912, 9846649} / utils::Fraction{-3518442, 5086997};
  REQUIRE(f1.numerator() == -15970403253632);
  REQUIRE(f1.denominator() == 17322431700429);
  // negative positive
  utils::Fraction f2 =
      utils::Fraction{-818086, 210847} / utils::Fraction{1012134, 86359};
  REQUIRE(f2.numerator() == -388181807);
  REQUIRE(f2.denominator() == 1172557239);
  // negative negative
  utils::Fraction f3 =
      utils::Fraction{-2916527, 2629343} / utils::Fraction{-4498061, 5187826};
  REQUIRE(f3.numerator() == 15130434600302);
  REQUIRE(f3.denominator() == 11826945203923);
  // 0 positive
  utils::Fraction f4 =
      utils::Fraction{0, 1} / utils::Fraction{4101953, 9793471};
  REQUIRE(f4.numerator() == 0);
  REQUIRE(f4.denominator() == 1);
  // 0 negative
  utils::Fraction f5 =
      utils::Fraction{0, 1} / utils::Fraction{-9804379, 7304334};
  REQUIRE(f5.numerator() == 0);
  REQUIRE(f5.denominator() == 1);
...
TEST_CASE("fraction fraction equals", "[utils][fraction]") {
  ...
  utils::Fraction f0{395027, 7918289};
  utils::Fraction f1{395027, 7918289};
  REQUIRE((f0 == f1) == true);
  // positive positive not equal
  utils::Fraction f2{5522729, 1838588};
  utils::Fraction f3{500786, 2494539};
  REQUIRE((f2 == f3) == false);
  // positive negative
  utils::Fraction f4{1653151, 6619608};
  utils::Fraction f5{-9082831, 5024934};
  REQUIRE((f4 == f5) == false);
  // positive 0
  utils::Fraction f6{8444623, 1434861};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 == f7) == false);
  // negative positive
  utils::Fraction f8{-7486411, 6257001};
  utils::Fraction f9{2593515, 9243037};
  REQUIRE((f8 == f9) == false);
  // negative negative equal
  utils::Fraction f10{-3502523, 9373887};
  utils::Fraction f11{-3502523, 9373887};
  REQUIRE((f10 == f11) == true);
  // negative negative not equal
  utils::Fraction f12{-1069983, 6202538};
  utils::Fraction f13{-2413556, 1558355};
  REQUIRE((f12 == f13) == false);
  // negative 0
  utils::Fraction f14{-1605071, 1463825};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 == f15) == false);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{403071, 601651};
  REQUIRE((f16 == f17) == false);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-3078073, 1348377};
...
TEST_CASE("fraction equals int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{96, 1};
  REQUIRE((f0 == int8_t{96}) == true);
  // positive positive not equal
  utils::Fraction f1{653810, 1493003};
  REQUIRE((f1 == int8_t{15}) == false);
  // positive negative
  utils::Fraction f2{183452, 1209487};
  REQUIRE((f2 == int8_t{-102}) == false);
  // positive 0
  utils::Fraction f3{9988565, 4933592};
  REQUIRE((f3 == int8_t{0}) == false);
  // negative positive
  utils::Fraction f4{-858011, 1614804};
  REQUIRE((f4 == int8_t{98}) == false);
  // negative negative equal
  utils::Fraction f5{-68, 1};
  REQUIRE((f5 == int8_t{-68}) == true);
  // negative negative not equal
  utils::Fraction f6{-5876944, 4440791};
  REQUIRE((f6 == int8_t{-63}) == false);
  // negative 0
  utils::Fraction f7{-4554365, 2528263};
...
TEST_CASE("uint8_t fraction equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{57, 1};
  REQUIRE((uint8_t{57} == f0) == true);
  // positive positive not equal
  utils::Fraction f1{6680192, 308089};
  REQUIRE((uint8_t{10} == f1) == false);
  // positive negative
  utils::Fraction f2{-451878, 141655};
  REQUIRE((uint8_t{124} == f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{114} == f3) == false);
  // 0 positive
  utils::Fraction f4{4082171, 3325404};
  REQUIRE((uint8_t{0} == f4) == false);
  // 0 negative
  utils::Fraction f5{-196326, 6014597};
...
TEST_CASE("fraction equals uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{88, 1};
  REQUIRE((f0 == uint8_t{88}) == true);
  // positive positive not equal
  utils::Fraction f1{1054969, 2394886};
  REQUIRE((f1 == uint8_t{83}) == false);
  // positive 0
  utils::Fraction f2{8514103, 2346648};
  REQUIRE((f2 == uint8_t{0}) == false);
  // negative positive
  utils::Fraction f3{-4603308, 8011867};
  REQUIRE((f3 == uint8_t{244}) == false);
  // negative 0
  utils::Fraction f4{-248126, 6352211};
...
TEST_CASE("fraction equals int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{8732, 1};
  REQUIRE((f0 == int16_t{8732}) == true);
  // positive positive not equal
  utils::Fraction f1{3416069, 4140162};
  REQUIRE((f1 == int16_t{31930}) == false);
  // positive negative
  utils::Fraction f2{3341817, 4376024};
  REQUIRE((f2 == int16_t{-24876}) == false);
  // positive 0
  utils::Fraction f3{4129738, 4081451};
  REQUIRE((f3 == int16_t{0}) == false);
  // negative positive
  utils::Fraction f4{-297158, 1093085};
  REQUIRE((f4 == int16_t{16916}) == false);
  // negative negative equal
  utils::Fraction f5{-9582, 1};
  REQUIRE((f5 == int16_t{-9582}) == true);
  // negative negative not equal
  utils::Fraction f6{-23462, 14581};
  REQUIRE((f6 == int16_t{-22678}) == false);
  // negative 0
  utils::Fraction f7{-739502, 2767595};
...
TEST_CASE("uint16_t fraction equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6266, 1};
  REQUIRE((uint16_t{6266} == f0) == true);
  // positive positive not equal
  utils::Fraction f1{7162029, 8168249};
  REQUIRE((uint16_t{11101} == f1) == false);
  // positive negative
  utils::Fraction f2{-4679517, 5482366};
  REQUIRE((uint16_t{1637} == f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{18547} == f3) == false);
  // 0 positive
  utils::Fraction f4{1168507, 6957153};
  REQUIRE((uint16_t{0} == f4) == false);
  // 0 negative
  utils::Fraction f5{-1107567, 1344028};
...
TEST_CASE("fraction equals uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{15883, 1};
  REQUIRE((f0 == uint16_t{15883}) == true);
  // positive positive not equal
  utils::Fraction f1{6695767, 4010184};
  REQUIRE((f1 == uint16_t{55933}) == false);
  // positive 0
  utils::Fraction f2{758174, 1904539};
  REQUIRE((f2 == uint16_t{0}) == false);
  // negative positive
  utils::Fraction f3{-1311689, 1905387};
  REQUIRE((f3 == uint16_t{29959}) == false);
  // negative 0
  utils::Fraction f4{-5242640, 9251919};
...
TEST_CASE("fraction equals int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4046384, 1};
  REQUIRE((f0 == int32_t{4046384}) == true);
  // positive positive not equal
  utils::Fraction f1{270361, 4790199};
  REQUIRE((f1 == int32_t{8222265}) == false);
  // positive negative
  utils::Fraction f2{4216387, 5853580};
  REQUIRE((f2 == int32_t{-7473569}) == false);
  // positive 0
  utils::Fraction f3{2989530, 546067};
  REQUIRE((f3 == int32_t{0}) == false);
  // negative positive
  utils::Fraction f4{-1143282, 1629203};
  REQUIRE((f4 == int32_t{9994675}) == false);
  // negative negative equal
  utils::Fraction f5{-3887733, 1};
  REQUIRE((f5 == int32_t{-3887733}) == true);
  // negative negative not equal
  utils::Fraction f6{-197188, 28301};
  REQUIRE((f6 == int32_t{-4007092}) == false);
  // negative 0
  utils::Fraction f7{-5453881, 9130265};
...
TEST_CASE("uint32_t fraction equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6012843, 1};
  REQUIRE((uint32_t{6012843} == f0) == true);
  // positive positive not equal
  utils::Fraction f1{2478201, 525542};
  REQUIRE((uint32_t{5567871} == f1) == false);
  // positive negative
  utils::Fraction f2{-5593955, 3645201};
  REQUIRE((uint32_t{8012397} == f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{832061} == f3) == false);
  // 0 positive
  utils::Fraction f4{2732633, 2328822};
  REQUIRE((uint32_t{0} == f4) == false);
  // 0 negative
  utils::Fraction f5{-1862348, 7218561};
...
TEST_CASE("fraction equals uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{5308606, 1};
  REQUIRE((f0 == uint32_t{5308606}) == true);
  // positive positive not equal
  utils::Fraction f1{6408298, 4663037};
  REQUIRE((f1 == uint32_t{5365928}) == false);
  // positive 0
  utils::Fraction f2{3889585, 1955384};
  REQUIRE((f2 == uint32_t{0}) == false);
  // negative positive
  utils::Fraction f3{-416481, 782117};
  REQUIRE((f3 == uint32_t{6635671}) == false);
  // negative 0
  utils::Fraction f4{-6321151, 3364326};
...
TEST_CASE("fraction equals int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{5491338, 1};
  REQUIRE((f0 == int64_t{5491338}) == true);
  // positive positive not equal
  utils::Fraction f1{3739007, 9071270};
  REQUIRE((f1 == int64_t{4617816}) == false);
  // positive negative
  utils::Fraction f2{5566306, 1001295};
  REQUIRE((f2 == int64_t{-3883077}) == false);
  // positive 0
  utils::Fraction f3{8677185, 6574148};
  REQUIRE((f3 == int64_t{0}) == false);
  // negative positive
  utils::Fraction f4{-6128263, 8862350};
  REQUIRE((f4 == int64_t{310511}) == false);
  // negative negative equal
  utils::Fraction f5{-7892018, 1};
  REQUIRE((f5 == int64_t{-7892018}) == true);
  // negative negative not equal
  utils::Fraction f6{-1139031, 880829};
  REQUIRE((f6 == int64_t{-4910053}) == false);
  // negative 0
  utils::Fraction f7{-578663, 599640};
...
TEST_CASE("fraction double equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{3653503836092857, 1073741824};
  REQUIRE((f0 == 3402590.598997527) == true);
  // positive positive not equal
  utils::Fraction f1{4807732, 1462449};
  REQUIRE((f1 == 9365301.769976139) == false);
  // positive negative
  utils::Fraction f2{6992843, 3569389};
  REQUIRE((f2 == -7965930.252493443) == false);
  // positive 0
  utils::Fraction f3{8541965, 5503668};
  REQUIRE((f3 == 0.0) == false);
  // negative positive
  utils::Fraction f4{-245564, 176733};
  REQUIRE((f4 == 8868685.441901067) == false);
  // negative negative equal
  utils::Fraction f5{-8579739230697913, 2147483648};
  REQUIRE((f5 == -3995252.4149315027) == true);
  // negative negative not equal
  utils::Fraction f6{-549681, 59416};
  REQUIRE((f6 == -7497956.29958038) == false);
  // negative 0
  utils::Fraction f7{-819669, 3820160};
...
TEST_CASE("fraction fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4784863, 5579732};
  utils::Fraction f1{4784863, 5579732};
  REQUIRE((f0 != f1) == false);
  // positive positive not equal
  utils::Fraction f2{1308302, 7994741};
  utils::Fraction f3{3446356, 7656447};
  REQUIRE((f2 != f3) == true);
  // positive negative
  utils::Fraction f4{4813924, 1638195};
  utils::Fraction f5{-4625168, 15569};
  REQUIRE((f4 != f5) == true);
  // positive 0
  utils::Fraction f6{8400731, 9692350};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 != f7) == true);
  // negative positive
  utils::Fraction f8{-4265593, 1939401};
  utils::Fraction f9{3150767, 2114575};
  REQUIRE((f8 != f9) == true);
  // negative negative equal
  utils::Fraction f10{-2727191, 1855821};
  utils::Fraction f11{-2727191, 1855821};
  REQUIRE((f10 != f11) == false);
  // negative negative not equal
  utils::Fraction f12{-2390935, 615831};
  utils::Fraction f13{-249716, 4216729};
  REQUIRE((f12 != f13) == true);
  // negative 0
  utils::Fraction f14{-265051, 9539524};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 != f15) == true);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{1929077, 2800867};
  REQUIRE((f16 != f17) == true);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-1152403, 6771032};
...
TEST_CASE("int8_t fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{63, 1};
  REQUIRE((int8_t{63} != f0) == false);
  // positive positive not equal
  utils::Fraction f1{1760445, 461227};
  REQUIRE((int8_t{121} != f1) == true);
  // positive negative
  utils::Fraction f2{-1657845, 1568159};
  REQUIRE((int8_t{103} != f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int8_t{40} != f3) == true);
  // negative positive
  utils::Fraction f4{9673555, 1083359};
  REQUIRE((int8_t{-45} != f4) == true);
  // negative negative equal
  utils::Fraction f5{-53, 1};
  REQUIRE((int8_t{-53} != f5) == false);
  // negative negative not equal
  utils::Fraction f6{-2814289, 542088};
  REQUIRE((int8_t{-118} != f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int8_t{-43} != f7) == true);
  // 0 positive
  utils::Fraction f8{6949375, 7057136};
  REQUIRE((int8_t{0} != f8) == true);
  // 0 negative
  utils::Fraction f9{-8778380, 6990739};
...
TEST_CASE("fraction not equals int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{47, 1};
  REQUIRE((f0 != int8_t{47}) == false);
  // positive positive not equal
  utils::Fraction f1{728194, 2995707};
  REQUIRE((f1 != int8_t{29}) == true);
  // positive negative
  utils::Fraction f2{8113505, 8442673};
  REQUIRE((f2 != int8_t{-77}) == true);
  // positive 0
  utils::Fraction f3{3139612, 1729479};
  REQUIRE((f3 != int8_t{0}) == true);
  // negative positive
  utils::Fraction f4{-2016401, 2046742};
  REQUIRE((f4 != int8_t{86}) == true);
  // negative negative equal
  utils::Fraction f5{-69, 1};
  REQUIRE((f5 != int8_t{-69}) == false);
  // negative negative not equal
  utils::Fraction f6{-8795107, 6029427};
  REQUIRE((f6 != int8_t{-87}) == true);
  // negative 0
  utils::Fraction f7{-8623496, 3714169};
...
TEST_CASE("uint8_t fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{206, 1};
  REQUIRE((uint8_t{206} != f0) == false);
  // positive positive not equal
  utils::Fraction f1{815125, 3526332};
  REQUIRE((uint8_t{182} != f1) == true);
  // positive negative
  utils::Fraction f2{-2092946, 2487003};
  REQUIRE((uint8_t{138} != f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{117} != f3) == true);
  // 0 positive
  utils::Fraction f4{4547037, 9412082};
  REQUIRE((uint8_t{0} != f4) == true);
  // 0 negative
  utils::Fraction f5{-6589879, 8444374};
...
TEST_CASE("fraction not equals uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{111, 1};
  REQUIRE((f0 != uint8_t{111}) == false);
  // positive positive not equal
  utils::Fraction f1{6824994, 9951467};
  REQUIRE((f1 != uint8_t{135}) == true);
  // positive 0
  utils::Fraction f2{31630, 622413};
  REQUIRE((f2 != uint8_t{0}) == true);
  // negative positive
  utils::Fraction f3{-8897591, 9429372};
  REQUIRE((f3 != uint8_t{82}) == true);
  // negative 0
  utils::Fraction f4{-9446328, 1710293};
...
TEST_CASE("fraction not equals int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{24514, 1};
  REQUIRE((f0 != int16_t{24514}) == false);
  // positive positive not equal
  utils::Fraction f1{8211865, 5676359};
  REQUIRE((f1 != int16_t{17771}) == true);
  // positive negative
  utils::Fraction f2{270461, 532224};
  REQUIRE((f2 != int16_t{-2152}) == true);
  // positive 0
  utils::Fraction f3{6841078, 9768049};
  REQUIRE((f3 != int16_t{0}) == true);
  // negative positive
  utils::Fraction f4{-9442327, 8532854};
  REQUIRE((f4 != int16_t{13913}) == true);
  // negative negative equal
  utils::Fraction f5{-24751, 1};
  REQUIRE((f5 != int16_t{-24751}) == false);
  // negative negative not equal
  utils::Fraction f6{-7151239, 5297165};
  REQUIRE((f6 != int16_t{-19737}) == true);
  // negative 0
  utils::Fraction f7{-8822595, 4606678};
...
TEST_CASE("uint16_t fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{16250, 1};
  REQUIRE((uint16_t{16250} != f0) == false);
  // positive positive not equal
  utils::Fraction f1{8334202, 271519};
  REQUIRE((uint16_t{37529} != f1) == true);
  // positive negative
  utils::Fraction f2{-1777815, 7207321};
  REQUIRE((uint16_t{3235} != f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{6594} != f3) == true);
  // 0 positive
  utils::Fraction f4{952553, 8659050};
  REQUIRE((uint16_t{0} != f4) == true);
  // 0 negative
  utils::Fraction f5{-367703, 725561};
...
TEST_CASE("fraction not equals uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{45576, 1};
  REQUIRE((f0 != uint16_t{45576}) == false);
  // positive positive not equal
  utils::Fraction f1{3445655, 5205664};
  REQUIRE((f1 != uint16_t{12022}) == true);
  // positive 0
  utils::Fraction f2{1155747, 334753};
  REQUIRE((f2 != uint16_t{0}) == true);
  // negative positive
  utils::Fraction f3{-6290495, 5471118};
  REQUIRE((f3 != uint16_t{49274}) == true);
  // negative 0
  utils::Fraction f4{-1801916, 1496543};
...
TEST_CASE("fraction not equals int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1396092, 1};
  REQUIRE((f0 != int32_t{1396092}) == false);
  // positive positive not equal
  utils::Fraction f1{8894893, 5789787};
  REQUIRE((f1 != int32_t{5711380}) == true);
  // positive negative
  utils::Fraction f2{2180453, 494664};
  REQUIRE((f2 != int32_t{-1250187}) == true);
  // positive 0
  utils::Fraction f3{1888843, 941913};
  REQUIRE((f3 != int32_t{0}) == true);
  // negative positive
  utils::Fraction f4{-636666, 1146665};
  REQUIRE((f4 != int32_t{1930684}) == true);
  // negative negative equal
  utils::Fraction f5{-4975878, 1};
  REQUIRE((f5 != int32_t{-4975878}) == false);
  // negative negative not equal
  utils::Fraction f6{-395183, 1872801};
  REQUIRE((f6 != int32_t{-1896270}) == true);
  // negative 0
  utils::Fraction f7{-7934282, 539787};
...
TEST_CASE("uint32_t fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{5563522, 1};
  REQUIRE((uint32_t{5563522} != f0) == false);
  // positive positive not equal
  utils::Fraction f1{3151475, 408136};
  REQUIRE((uint32_t{7472871} != f1) == true);
  // positive negative
  utils::Fraction f2{-3312928, 3241323};
  REQUIRE((uint32_t{3913709} != f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{574345} != f3) == true);
  // 0 positive
  utils::Fraction f4{4893291, 298703};
  REQUIRE((uint32_t{0} != f4) == true);
  // 0 negative
  utils::Fraction f5{-1509221, 4073162};
...
TEST_CASE("fraction not equals uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4964319, 1};
  REQUIRE((f0 != uint32_t{4964319}) == false);
  // positive positive not equal
  utils::Fraction f1{2617807, 9183075};
  REQUIRE((f1 != uint32_t{74089}) == true);
  // positive 0
  utils::Fraction f2{5254691, 5816550};
  REQUIRE((f2 != uint32_t{0}) == true);
  // negative positive
  utils::Fraction f3{-3113426, 885985};
  REQUIRE((f3 != uint32_t{6633685}) == true);
  // negative 0
  utils::Fraction f4{-9190648, 3104237};
...
TEST_CASE("fraction not equals int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1086373, 1};
  REQUIRE((f0 != int64_t{1086373}) == false);
  // positive positive not equal
  utils::Fraction f1{1243279, 921932};
  REQUIRE((f1 != int64_t{1655786}) == true);
  // positive negative
  utils::Fraction f2{5921679, 3589703};
  REQUIRE((f2 != int64_t{-663184}) == true);
  // positive 0
  utils::Fraction f3{175735, 113507};
  REQUIRE((f3 != int64_t{0}) == true);
  // negative positive
  utils::Fraction f4{-5551878, 5215367};
  REQUIRE((f4 != int64_t{34322}) == true);
  // negative negative equal
  utils::Fraction f5{-8550176, 1};
  REQUIRE((f5 != int64_t{-8550176}) == false);
  // negative negative not equal
  utils::Fraction f6{-1153810, 1273191};
  REQUIRE((f6 != int64_t{-8135654}) == true);
  // negative 0
  utils::Fraction f7{-5058351, 8535164};
...
TEST_CASE("double fraction not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{5133499974770585, 34359738368};
  REQUIRE((149404.51291536985 != f0) == false);
  // positive positive not equal
  utils::Fraction f1{8059762, 188615};
  REQUIRE((5362800.232690665 != f1) == true);
  // positive negative
  utils::Fraction f2{-4902649, 6702049};
  REQUIRE((8665515.00836767 != f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((6390471.586417233 != f3) == true);
  // negative positive
  utils::Fraction f4{4260741, 8412316};
  REQUIRE((-6294873.300062752 != f4) == true);
  // negative negative equal
  utils::Fraction f5{-2121792849246457, 536870912};
  REQUIRE((-3952147.1583218444 != f5) == false);
  // negative negative not equal
  utils::Fraction f6{-7027706, 6777077};
  REQUIRE((-8491979.624541113 != f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((-185726.15206693986 != f7) == true);
  // 0 positive
  utils::Fraction f8{4677616, 3286375};
  REQUIRE((0.0 != f8) == true);
  // 0 negative
  utils::Fraction f9{-9176744, 3473681};
  REQUIRE((0.0 != f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
...
TEST_CASE("fraction double not equals", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{5939754552283169, 8589934592};
  REQUIRE((f0 != 691478.4377770462) == false);
  // positive positive not equal
  utils::Fraction f1{4968715, 1513492};
  REQUIRE((f1 != 2062128.0540153321) == true);
  // positive negative
  utils::Fraction f2{1573199, 1514019};
  REQUIRE((f2 != -9359109.03770745) == true);
  // positive 0
  utils::Fraction f3{3850703, 1632702};
  REQUIRE((f3 != 0.0) == true);
  // negative positive
  utils::Fraction f4{-7901725, 8421009};
  REQUIRE((f4 != 7706090.605823248) == true);
  // negative negative equal
  utils::Fraction f5{-87831276472221, 33554432};
  REQUIRE((f5 != -2617576.0171479285) == false);
  // negative negative not equal
  utils::Fraction f6{-8277083, 579668};
  REQUIRE((f6 != -3113123.563958323) == true);
  // negative 0
  utils::Fraction f7{-7905317, 3014447};
  REQUIRE((f7 != 0.0) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("fraction fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{8540447, 3219370};
  utils::Fraction f1{8540447, 3219370};
  REQUIRE((f0 < f1) == false);
  // positive positive not equal
  utils::Fraction f2{362907, 565562};
  utils::Fraction f3{2443021, 4281737};
  REQUIRE((f2 < f3) == false);
  // positive negative
  utils::Fraction f4{116081, 75224};
  utils::Fraction f5{-1213180, 4830363};
  REQUIRE((f4 < f5) == false);
  // positive 0
  utils::Fraction f6{5748365, 3796257};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 < f7) == false);
  // negative positive
  utils::Fraction f8{-7405364, 1738907};
  utils::Fraction f9{4154139, 3315332};
  REQUIRE((f8 < f9) == true);
  // negative negative equal
  utils::Fraction f10{-8111219, 5917911};
  utils::Fraction f11{-8111219, 5917911};
  REQUIRE((f10 < f11) == false);
  // negative negative not equal
  utils::Fraction f12{-1163783, 996192};
  utils::Fraction f13{-8466569, 5265962};
  REQUIRE((f12 < f13) == false);
  // negative 0
  utils::Fraction f14{-7898356, 1319409};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 < f15) == true);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{797034, 1674971};
  REQUIRE((f16 < f17) == true);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-2483077, 7867310};
  REQUIRE((f18 < f19) == false);
  // 0 0
  utils::Fraction f20{0, 1};
  utils::Fraction f21{0, 1};
...
TEST_CASE("int8_t fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{61, 1};
  REQUIRE((int8_t{61} < f0) == false);
  // positive positive not equal
  utils::Fraction f1{1057403, 3267472};
  REQUIRE((int8_t{107} < f1) == false);
  // positive negative
  utils::Fraction f2{-985017, 522587};
  REQUIRE((int8_t{64} < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int8_t{67} < f3) == false);
  // negative positive
  utils::Fraction f4{9839115, 9856051};
  REQUIRE((int8_t{-105} < f4) == true);
  // negative negative equal
  utils::Fraction f5{-52, 1};
  REQUIRE((int8_t{-52} < f5) == false);
  // negative negative not equal
  utils::Fraction f6{-8612616, 1812959};
  REQUIRE((int8_t{-58} < f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int8_t{-55} < f7) == true);
  // 0 positive
  utils::Fraction f8{7333444, 5362233};
  REQUIRE((int8_t{0} < f8) == true);
  // 0 negative
  utils::Fraction f9{-1051667, 1695235};
  REQUIRE((int8_t{0} < f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int8_t{0} < f10) == false);
...
TEST_CASE("fraction less than int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{120, 1};
  REQUIRE((f0 < int8_t{120}) == false);
  // positive positive not equal
  utils::Fraction f1{8906819, 7139994};
  REQUIRE((f1 < int8_t{77}) == true);
  // positive negative
  utils::Fraction f2{1194967, 3226848};
  REQUIRE((f2 < int8_t{-15}) == false);
  // positive 0
  utils::Fraction f3{2754191, 3748174};
  REQUIRE((f3 < int8_t{0}) == false);
  // negative positive
  utils::Fraction f4{-2605963, 2804261};
  REQUIRE((f4 < int8_t{37}) == true);
  // negative negative equal
  utils::Fraction f5{-6, 1};
  REQUIRE((f5 < int8_t{-6}) == false);
  // negative negative not equal
  utils::Fraction f6{-740135, 802424};
  REQUIRE((f6 < int8_t{-22}) == false);
  // negative 0
  utils::Fraction f7{-4533371, 1716435};
  REQUIRE((f7 < int8_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint8_t fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{131, 1};
  REQUIRE((uint8_t{131} < f0) == false);
  // positive positive not equal
  utils::Fraction f1{123640, 77749};
  REQUIRE((uint8_t{76} < f1) == false);
  // positive negative
  utils::Fraction f2{-2034643, 2455567};
  REQUIRE((uint8_t{41} < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{30} < f3) == false);
  // 0 positive
  utils::Fraction f4{3763, 1656};
  REQUIRE((uint8_t{0} < f4) == true);
  // 0 negative
  utils::Fraction f5{-2527, 30550};
  REQUIRE((uint8_t{0} < f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint8_t{0} < f6) == false);
...
TEST_CASE("fraction less than uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{73, 1};
  REQUIRE((f0 < uint8_t{73}) == false);
  // positive positive not equal
  utils::Fraction f1{1752433, 1412412};
  REQUIRE((f1 < uint8_t{94}) == true);
  // positive 0
  utils::Fraction f2{270247, 471169};
  REQUIRE((f2 < uint8_t{0}) == false);
  // negative positive
  utils::Fraction f3{-6903737, 6191423};
  REQUIRE((f3 < uint8_t{247}) == true);
  // negative 0
  utils::Fraction f4{-572419, 1363606};
  REQUIRE((f4 < uint8_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int16_t fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{10134, 1};
  REQUIRE((int16_t{10134} < f0) == false);
  // positive positive not equal
  utils::Fraction f1{9468314, 1232737};
  REQUIRE((int16_t{21704} < f1) == false);
  // positive negative
  utils::Fraction f2{-697143, 832978};
  REQUIRE((int16_t{17175} < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int16_t{25495} < f3) == false);
  // negative positive
  utils::Fraction f4{9258436, 1935357};
  REQUIRE((int16_t{-8866} < f4) == true);
  // negative negative equal
  utils::Fraction f5{-13281, 1};
  REQUIRE((int16_t{-13281} < f5) == false);
  // negative negative not equal
  utils::Fraction f6{-3082514, 2756435};
  REQUIRE((int16_t{-17767} < f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int16_t{-4555} < f7) == true);
  // 0 positive
  utils::Fraction f8{1083658, 3279343};
  REQUIRE((int16_t{0} < f8) == true);
  // 0 negative
  utils::Fraction f9{-4121519, 3581390};
  REQUIRE((int16_t{0} < f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int16_t{0} < f10) == false);
...
TEST_CASE("fraction less than int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{13079, 1};
  REQUIRE((f0 < int16_t{13079}) == false);
  // positive positive not equal
  utils::Fraction f1{6828599, 7380619};
  REQUIRE((f1 < int16_t{22122}) == true);
  // positive negative
  utils::Fraction f2{9517192, 9352149};
  REQUIRE((f2 < int16_t{-24507}) == false);
  // positive 0
  utils::Fraction f3{5142993, 2245807};
  REQUIRE((f3 < int16_t{0}) == false);
  // negative positive
  utils::Fraction f4{-1168873, 7330980};
  REQUIRE((f4 < int16_t{11933}) == true);
  // negative negative equal
  utils::Fraction f5{-6659, 1};
  REQUIRE((f5 < int16_t{-6659}) == false);
  // negative negative not equal
  utils::Fraction f6{-3399045, 8884271};
  REQUIRE((f6 < int16_t{-18194}) == false);
  // negative 0
  utils::Fraction f7{-1972161, 9858856};
  REQUIRE((f7 < int16_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint16_t fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{2980, 1};
  REQUIRE((uint16_t{2980} < f0) == false);
  // positive positive not equal
  utils::Fraction f1{3646793, 830316};
  REQUIRE((uint16_t{28367} < f1) == false);
  // positive negative
  utils::Fraction f2{-1790000, 2271767};
  REQUIRE((uint16_t{54486} < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{15549} < f3) == false);
  // 0 positive
  utils::Fraction f4{165959, 133837};
  REQUIRE((uint16_t{0} < f4) == true);
  // 0 negative
  utils::Fraction f5{-2365008, 2081059};
  REQUIRE((uint16_t{0} < f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint16_t{0} < f6) == false);
...
TEST_CASE("fraction less than uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{30252, 1};
  REQUIRE((f0 < uint16_t{30252}) == false);
  // positive positive not equal
  utils::Fraction f1{2385633, 1444493};
  REQUIRE((f1 < uint16_t{52309}) == true);
  // positive 0
  utils::Fraction f2{721882, 5042351};
  REQUIRE((f2 < uint16_t{0}) == false);
  // negative positive
  utils::Fraction f3{-3014167, 2805546};
  REQUIRE((f3 < uint16_t{36549}) == true);
  // negative 0
  utils::Fraction f4{-1988807, 1598002};
  REQUIRE((f4 < uint16_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction less than int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{9034175, 1};
  REQUIRE((f0 < int32_t{9034175}) == false);
  // positive positive not equal
  utils::Fraction f1{1977596, 5150383};
  REQUIRE((f1 < int32_t{2417311}) == true);
  // positive negative
  utils::Fraction f2{7882623, 4354832};
  REQUIRE((f2 < int32_t{-9245979}) == false);
  // positive 0
  utils::Fraction f3{2304247, 2814259};
  REQUIRE((f3 < int32_t{0}) == false);
  // negative positive
  utils::Fraction f4{-9968219, 3278035};
  REQUIRE((f4 < int32_t{7518104}) == true);
  // negative negative equal
  utils::Fraction f5{-4044422, 1};
  REQUIRE((f5 < int32_t{-4044422}) == false);
  // negative negative not equal
  utils::Fraction f6{-717091, 5009205};
  REQUIRE((f6 < int32_t{-9798911}) == false);
  // negative 0
  utils::Fraction f7{-3674459, 9474706};
  REQUIRE((f7 < int32_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint32_t fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6016604, 1};
  REQUIRE((uint32_t{6016604} < f0) == false);
  // positive positive not equal
  utils::Fraction f1{2809468, 2728221};
  REQUIRE((uint32_t{7010763} < f1) == false);
  // positive negative
  utils::Fraction f2{-4225048, 2078937};
  REQUIRE((uint32_t{5796594} < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{2261799} < f3) == false);
  // 0 positive
  utils::Fraction f4{7539845, 5198117};
  REQUIRE((uint32_t{0} < f4) == true);
  // 0 negative
  utils::Fraction f5{-18797, 145849};
  REQUIRE((uint32_t{0} < f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint32_t{0} < f6) == false);
...
TEST_CASE("fraction less than uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{3014545, 1};
  REQUIRE((f0 < uint32_t{3014545}) == false);
  // positive positive not equal
  utils::Fraction f1{7053268, 9297953};
  REQUIRE((f1 < uint32_t{5001268}) == true);
  // positive 0
  utils::Fraction f2{9456485, 2316351};
  REQUIRE((f2 < uint32_t{0}) == false);
  // negative positive
  utils::Fraction f3{-2773235, 8455707};
  REQUIRE((f3 < uint32_t{5935514}) == true);
  // negative 0
  utils::Fraction f4{-5344745, 7256276};
  REQUIRE((f4 < uint32_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction less than int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{8147760, 1};
  REQUIRE((f0 < int64_t{8147760}) == false);
  // positive positive not equal
  utils::Fraction f1{1762307, 1690891};
  REQUIRE((f1 < int64_t{2601018}) == true);
  // positive negative
  utils::Fraction f2{1394922, 194015};
  REQUIRE((f2 < int64_t{-5495969}) == false);
  // positive 0
  utils::Fraction f3{6528835, 4565026};
  REQUIRE((f3 < int64_t{0}) == false);
  // negative positive
  utils::Fraction f4{-85952, 256437};
  REQUIRE((f4 < int64_t{5654123}) == true);
  // negative negative equal
  utils::Fraction f5{-712694, 1};
  REQUIRE((f5 < int64_t{-712694}) == false);
  // negative negative not equal
  utils::Fraction f6{-463616, 1198685};
  REQUIRE((f6 < int64_t{-4909575}) == false);
  // negative 0
  utils::Fraction f7{-465731, 3309};
  REQUIRE((f7 < int64_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("double fraction less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{2714023686310977, 4294967296};
  REQUIRE((631907.8817756327 < f0) == false);
  // positive positive not equal
  utils::Fraction f1{2293707, 730082};
  REQUIRE((8551371.46365554 < f1) == false);
  // positive negative
  utils::Fraction f2{-9759203, 5464488};
  REQUIRE((5197171.650309762 < f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((9876655.147697639 < f3) == false);
  // negative positive
  utils::Fraction f4{3499685, 7604277};
  REQUIRE((-6762481.577767846 < f4) == true);
  // negative negative equal
  utils::Fraction f5{-671404346248769, 134217728};
  REQUIRE((-5002352.194851406 < f5) == false);
  // negative negative not equal
  utils::Fraction f6{-9623750, 4072491};
  REQUIRE((-7066924.656570608 < f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((-2330608.7200199403 < f7) == true);
  // 0 positive
  utils::Fraction f8{658069, 1655447};
  REQUIRE((0.0 < f8) == true);
  // 0 negative
  utils::Fraction f9{-1787259, 163543};
  REQUIRE((0.0 < f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((0.0 < f10) == false);
...
TEST_CASE("fraction double less than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{3061389050079025, 536870912};
  REQUIRE((f0 < 5702281.464038463) == false);
  // positive positive not equal
  utils::Fraction f1{4662548, 6063049};
  REQUIRE((f1 < 3096757.626819014) == true);
  // positive negative
  utils::Fraction f2{3155499, 1306043};
  REQUIRE((f2 < -6960659.785650445) == false);
  // positive 0
  utils::Fraction f3{2183279, 1349786};
  REQUIRE((f3 < 0.0) == false);
  // negative positive
  utils::Fraction f4{-6455062, 5812399};
  REQUIRE((f4 < 7484126.118552723) == true);
  // negative negative equal
  utils::Fraction f5{-1357212609795887, 1073741824};
  REQUIRE((f5 < -1264002.7420556983) == false);
  // negative negative not equal
  utils::Fraction f6{-3525461, 5070218};
  REQUIRE((f6 < -454379.9661124032) == false);
  // negative 0
  utils::Fraction f7{-1160368, 471533};
  REQUIRE((f7 < 0.0) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("fraction fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{9967595, 6189591};
  utils::Fraction f1{9967595, 6189591};
  REQUIRE((f0 > f1) == false);
  // positive positive not equal
  utils::Fraction f2{2664073, 1693021};
  utils::Fraction f3{2922779, 9076736};
  REQUIRE((f2 > f3) == true);
  // positive negative
  utils::Fraction f4{2573539, 2307641};
  utils::Fraction f5{-117466, 4038781};
  REQUIRE((f4 > f5) == true);
  // positive 0
  utils::Fraction f6{3220471, 8326864};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 > f7) == true);
  // negative positive
  utils::Fraction f8{-1072411, 963001};
  utils::Fraction f9{5327717, 5507702};
  REQUIRE((f8 > f9) == false);
  // negative negative equal
  utils::Fraction f10{-1348727, 2150245};
  utils::Fraction f11{-1348727, 2150245};
  REQUIRE((f10 > f11) == false);
  // negative negative not equal
  utils::Fraction f12{-1386622, 2158625};
  utils::Fraction f13{-6611513, 93811};
  REQUIRE((f12 > f13) == true);
  // negative 0
  utils::Fraction f14{-5634589, 3952187};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 > f15) == false);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{1598313, 1451936};
  REQUIRE((f16 > f17) == false);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-2627840, 2533647};
  REQUIRE((f18 > f19) == true);
  // 0 0
  utils::Fraction f20{0, 1};
  utils::Fraction f21{0, 1};
...
TEST_CASE("int8_t fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{72, 1};
  REQUIRE((int8_t{72} > f0) == false);
  // positive positive not equal
  utils::Fraction f1{3712351, 3804601};
  REQUIRE((int8_t{25} > f1) == true);
  // positive negative
  utils::Fraction f2{-2080189, 3292815};
  REQUIRE((int8_t{45} > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int8_t{24} > f3) == true);
  // negative positive
  utils::Fraction f4{4603087, 7983207};
  REQUIRE((int8_t{-73} > f4) == false);
  // negative negative equal
  utils::Fraction f5{-97, 1};
  REQUIRE((int8_t{-97} > f5) == false);
  // negative negative not equal
  utils::Fraction f6{-1624811, 823681};
  REQUIRE((int8_t{-68} > f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int8_t{-48} > f7) == false);
  // 0 positive
  utils::Fraction f8{692855, 9636558};
  REQUIRE((int8_t{0} > f8) == false);
  // 0 negative
  utils::Fraction f9{-8039673, 9455035};
  REQUIRE((int8_t{0} > f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int8_t{0} > f10) == false);
...
TEST_CASE("fraction greater than int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{9, 1};
  REQUIRE((f0 > int8_t{9}) == false);
  // positive positive not equal
  utils::Fraction f1{557354, 872509};
  REQUIRE((f1 > int8_t{124}) == false);
  // positive negative
  utils::Fraction f2{9121865, 2716217};
  REQUIRE((f2 > int8_t{-91}) == true);
  // positive 0
  utils::Fraction f3{2005663, 980721};
  REQUIRE((f3 > int8_t{0}) == true);
  // negative positive
  utils::Fraction f4{-9986085, 2294713};
  REQUIRE((f4 > int8_t{26}) == false);
  // negative negative equal
  utils::Fraction f5{-22, 1};
  REQUIRE((f5 > int8_t{-22}) == false);
  // negative negative not equal
  utils::Fraction f6{-8149503, 1651724};
  REQUIRE((f6 > int8_t{-49}) == true);
  // negative 0
  utils::Fraction f7{-7613472, 7514465};
  REQUIRE((f7 > int8_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint8_t fraction greater than", "[utils][fraction]") {
  ...
  // positive positive not equal
  utils::Fraction f1{4074053, 4028494};
  REQUIRE((uint8_t{237} > f1) == true);
  // positive negative
  utils::Fraction f2{-97091, 123974};
  REQUIRE((uint8_t{215} > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{221} > f3) == true);
  // 0 positive
  utils::Fraction f4{1320353, 194656};
  REQUIRE((uint8_t{0} > f4) == false);
  // 0 negative
  utils::Fraction f5{-1807597, 1490011};
  REQUIRE((uint8_t{0} > f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint8_t{0} > f6) == false);
...
TEST_CASE("fraction greater than uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{44, 1};
  REQUIRE((f0 > uint8_t{44}) == false);
  // positive positive not equal
  utils::Fraction f1{1836399, 1415543};
  REQUIRE((f1 > uint8_t{191}) == false);
  // positive 0
  utils::Fraction f2{9025088, 8435049};
  REQUIRE((f2 > uint8_t{0}) == true);
  // negative positive
  utils::Fraction f3{-1656437, 1237877};
  REQUIRE((f3 > uint8_t{30}) == false);
  // negative 0
  utils::Fraction f4{-65292, 720821};
  REQUIRE((f4 > uint8_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int16_t fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{14810, 1};
  REQUIRE((int16_t{14810} > f0) == false);
  // positive positive not equal
  utils::Fraction f1{2070333, 2133127};
  REQUIRE((int16_t{28444} > f1) == true);
  // positive negative
  utils::Fraction f2{-4564042, 2594255};
  REQUIRE((int16_t{32698} > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int16_t{20254} > f3) == true);
  // negative positive
  utils::Fraction f4{893356, 5789555};
  REQUIRE((int16_t{-24758} > f4) == false);
  // negative negative equal
  utils::Fraction f5{-8102, 1};
  REQUIRE((int16_t{-8102} > f5) == false);
  // negative negative not equal
  utils::Fraction f6{-7425583, 2272461};
  REQUIRE((int16_t{-11308} > f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int16_t{-24838} > f7) == false);
  // 0 positive
  utils::Fraction f8{4014267, 3638408};
  REQUIRE((int16_t{0} > f8) == false);
  // 0 negative
  utils::Fraction f9{-1285813, 738198};
  REQUIRE((int16_t{0} > f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int16_t{0} > f10) == false);
...
TEST_CASE("fraction greater than int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{31947, 1};
  REQUIRE((f0 > int16_t{31947}) == false);
  // positive positive not equal
  utils::Fraction f1{1564469, 2182793};
  REQUIRE((f1 > int16_t{6443}) == false);
  // positive negative
  utils::Fraction f2{3882416, 6892561};
  REQUIRE((f2 > int16_t{-20522}) == true);
  // positive 0
  utils::Fraction f3{7208843, 2612456};
  REQUIRE((f3 > int16_t{0}) == true);
  // negative positive
  utils::Fraction f4{-98481, 12584};
  REQUIRE((f4 > int16_t{1029}) == false);
  // negative negative equal
  utils::Fraction f5{-638, 1};
  REQUIRE((f5 > int16_t{-638}) == false);
  // negative negative not equal
  utils::Fraction f6{-4250731, 2216866};
  REQUIRE((f6 > int16_t{-25980}) == true);
  // negative 0
  utils::Fraction f7{-154171, 376395};
  REQUIRE((f7 > int16_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint16_t fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{3310, 1};
  REQUIRE((uint16_t{3310} > f0) == false);
  // positive positive not equal
  utils::Fraction f1{6213096, 9926603};
  REQUIRE((uint16_t{12200} > f1) == true);
  // positive negative
  utils::Fraction f2{-5878376, 4271019};
  REQUIRE((uint16_t{2226} > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{18437} > f3) == true);
  // 0 positive
  utils::Fraction f4{1901182, 208957};
  REQUIRE((uint16_t{0} > f4) == false);
  // 0 negative
  utils::Fraction f5{-4019812, 2366487};
  REQUIRE((uint16_t{0} > f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint16_t{0} > f6) == false);
...
TEST_CASE("fraction greater than uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{39959, 1};
  REQUIRE((f0 > uint16_t{39959}) == false);
  // positive positive not equal
  utils::Fraction f1{5186598, 3555803};
  REQUIRE((f1 > uint16_t{41003}) == false);
  // positive 0
  utils::Fraction f2{2470742, 766491};
  REQUIRE((f2 > uint16_t{0}) == true);
  // negative positive
  utils::Fraction f3{-9532895, 8021366};
  REQUIRE((f3 > uint16_t{11241}) == false);
  // negative 0
  utils::Fraction f4{-2054347, 2029331};
  REQUIRE((f4 > uint16_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction greater than int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6383979, 1};
  REQUIRE((f0 > int32_t{6383979}) == false);
  // positive positive not equal
  utils::Fraction f1{5952236, 3194699};
  REQUIRE((f1 > int32_t{7200194}) == false);
  // positive negative
  utils::Fraction f2{4430229, 6557258};
  REQUIRE((f2 > int32_t{-2820456}) == true);
  // positive 0
  utils::Fraction f3{965489, 4136248};
  REQUIRE((f3 > int32_t{0}) == true);
  // negative positive
  utils::Fraction f4{-5261345, 4758188};
  REQUIRE((f4 > int32_t{4368700}) == false);
  // negative negative equal
  utils::Fraction f5{-310317, 1};
  REQUIRE((f5 > int32_t{-310317}) == false);
  // negative negative not equal
  utils::Fraction f6{-1056143, 1809342};
  REQUIRE((f6 > int32_t{-2386830}) == true);
  // negative 0
  utils::Fraction f7{-1894077, 5087215};
  REQUIRE((f7 > int32_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint32_t fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{7418184, 1};
  REQUIRE((uint32_t{7418184} > f0) == false);
  // positive positive not equal
  utils::Fraction f1{901623, 9191554};
  REQUIRE((uint32_t{3664785} > f1) == true);
  // positive negative
  utils::Fraction f2{-8580020, 668783};
  REQUIRE((uint32_t{3928957} > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{5891969} > f3) == true);
  // 0 positive
  utils::Fraction f4{9780072, 6937123};
  REQUIRE((uint32_t{0} > f4) == false);
  // 0 negative
  utils::Fraction f5{-1510472, 3440209};
  REQUIRE((uint32_t{0} > f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint32_t{0} > f6) == false);
...
TEST_CASE("fraction greater than uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1615579, 1};
  REQUIRE((f0 > uint32_t{1615579}) == false);
  // positive positive not equal
  utils::Fraction f1{2383244, 710225};
  REQUIRE((f1 > uint32_t{3702604}) == false);
  // positive 0
  utils::Fraction f2{2624223, 4043035};
  REQUIRE((f2 > uint32_t{0}) == true);
  // negative positive
  utils::Fraction f3{-2448917, 9791315};
  REQUIRE((f3 > uint32_t{1204216}) == false);
  // negative 0
  utils::Fraction f4{-9384600, 3720331};
  REQUIRE((f4 > uint32_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction greater than int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{2137138, 1};
  REQUIRE((f0 > int64_t{2137138}) == false);
  // positive positive not equal
  utils::Fraction f1{244987, 3196484};
  REQUIRE((f1 > int64_t{1541838}) == false);
  // positive negative
  utils::Fraction f2{7196639, 2312177};
  REQUIRE((f2 > int64_t{-5503663}) == true);
  // positive 0
  utils::Fraction f3{3592941, 7624658};
  REQUIRE((f3 > int64_t{0}) == true);
  // negative positive
  utils::Fraction f4{-2150725, 687062};
  REQUIRE((f4 > int64_t{8680752}) == false);
  // negative negative equal
  utils::Fraction f5{-4560139, 1};
  REQUIRE((f5 > int64_t{-4560139}) == false);
  // negative negative not equal
  utils::Fraction f6{-727126, 6039271};
  REQUIRE((f6 > int64_t{-926072}) == true);
  // negative 0
  utils::Fraction f7{-8117923, 654924};
  REQUIRE((f7 > int64_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("double fraction greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{240909929199551, 134217728};
  REQUIRE((1794918.8441004679 > f0) == false);
  // positive positive not equal
  utils::Fraction f1{3325918, 3407157};
  REQUIRE((4229827.585698447 > f1) == true);
  // positive negative
  utils::Fraction f2{-7014801, 1022575};
  REQUIRE((5215326.5987070855 > f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((4705655.145330848 > f3) == true);
  // negative positive
  utils::Fraction f4{550502, 1823317};
  REQUIRE((-5755912.976165803 > f4) == false);
  // negative negative equal
  utils::Fraction f5{-6262903176449291, 2147483648};
  REQUIRE((-2916391.555429106 > f5) == false);
  // negative negative not equal
  utils::Fraction f6{-4415803, 1667649};
  REQUIRE((-248338.3012445136 > f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((-3633962.9005279047 > f7) == false);
  // 0 positive
  utils::Fraction f8{2205923, 2794956};
  REQUIRE((0.0 > f8) == false);
  // 0 negative
  utils::Fraction f9{-9964193, 2017823};
  REQUIRE((0.0 > f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((0.0 > f10) == false);
...
TEST_CASE("fraction double greater than", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4639766230518337, 8589934592};
  REQUIRE((f0 > 540139.8789275364) == false);
  // positive positive not equal
  utils::Fraction f1{8543101, 5507658};
  REQUIRE((f1 > 4787784.486846527) == false);
  // positive negative
  utils::Fraction f2{686244, 2080895};
  REQUIRE((f2 > -3304423.5235274276) == true);
  // positive 0
  utils::Fraction f3{2842673, 8969520};
  REQUIRE((f3 > 0.0) == true);
  // negative positive
  utils::Fraction f4{-570798, 1471933};
  REQUIRE((f4 > 900097.0324797522) == false);
  // negative negative equal
  utils::Fraction f5{-1487394666958409, 268435456};
  REQUIRE((f5 > -5540976.922804151) == false);
  // negative negative not equal
  utils::Fraction f6{-224556, 572981};
  REQUIRE((f6 > -2900181.5245582405) == true);
  // negative 0
  utils::Fraction f7{-3291593, 7725586};
  REQUIRE((f7 > 0.0) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("fraction fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6631960, 6091141};
  utils::Fraction f1{6631960, 6091141};
  REQUIRE((f0 <= f1) == true);
  // positive positive not equal
  utils::Fraction f2{65709, 9524611};
  utils::Fraction f3{43599, 49496};
  REQUIRE((f2 <= f3) == true);
  // positive negative
  utils::Fraction f4{2336801, 3496762};
  utils::Fraction f5{-8019797, 9823918};
  REQUIRE((f4 <= f5) == false);
  // positive 0
  utils::Fraction f6{1819918, 3276331};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 <= f7) == false);
  // negative positive
  utils::Fraction f8{-210539, 2865453};
  utils::Fraction f9{3013102, 7868451};
  REQUIRE((f8 <= f9) == true);
  // negative negative equal
  utils::Fraction f10{-4752698, 3121611};
  utils::Fraction f11{-4752698, 3121611};
  REQUIRE((f10 <= f11) == true);
  // negative negative not equal
  utils::Fraction f12{-5998921, 8716915};
  utils::Fraction f13{-7280574, 8332439};
  REQUIRE((f12 <= f13) == false);
  // negative 0
  utils::Fraction f14{-892322, 1486111};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 <= f15) == true);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{5823107, 4079786};
  REQUIRE((f16 <= f17) == true);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-9829381, 4082159};
  REQUIRE((f18 <= f19) == false);
  // 0 0
  utils::Fraction f20{0, 1};
  utils::Fraction f21{0, 1};
...
TEST_CASE("int8_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{43, 1};
  REQUIRE((int8_t{43} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{3746045, 2514741};
  REQUIRE((int8_t{56} <= f1) == false);
  // positive negative
  utils::Fraction f2{-8488441, 1032060};
  REQUIRE((int8_t{20} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int8_t{62} <= f3) == false);
  // negative positive
  utils::Fraction f4{293414, 255897};
  REQUIRE((int8_t{-27} <= f4) == true);
  // negative negative equal
  utils::Fraction f5{-74, 1};
  REQUIRE((int8_t{-74} <= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-9807161, 12461};
  REQUIRE((int8_t{-90} <= f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int8_t{-113} <= f7) == true);
  // 0 positive
  utils::Fraction f8{252636, 54949};
  REQUIRE((int8_t{0} <= f8) == true);
  // 0 negative
  utils::Fraction f9{-234221, 4874713};
  REQUIRE((int8_t{0} <= f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int8_t{0} <= f10) == true);
...
TEST_CASE("fraction less than equal to int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{116, 1};
  REQUIRE((f0 <= int8_t{116}) == true);
  // positive positive not equal
  utils::Fraction f1{701852, 3204291};
  REQUIRE((f1 <= int8_t{10}) == true);
  // positive negative
  utils::Fraction f2{6228099, 3180925};
  REQUIRE((f2 <= int8_t{-105}) == false);
  // positive 0
  utils::Fraction f3{1030043, 255170};
  REQUIRE((f3 <= int8_t{0}) == false);
  // negative positive
  utils::Fraction f4{-3758861, 7494501};
  REQUIRE((f4 <= int8_t{41}) == true);
  // negative negative equal
  utils::Fraction f5{-48, 1};
  REQUIRE((f5 <= int8_t{-48}) == true);
  // negative negative not equal
  utils::Fraction f6{-6528171, 7365641};
  REQUIRE((f6 <= int8_t{-115}) == false);
  // negative 0
  utils::Fraction f7{-2341547, 1105071};
  REQUIRE((f7 <= int8_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint8_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1, 1};
  REQUIRE((uint8_t{1} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{3300089, 72413};
  REQUIRE((uint8_t{189} <= f1) == false);
  // positive negative
  utils::Fraction f2{-1305462, 6338333};
  REQUIRE((uint8_t{233} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{20} <= f3) == false);
  // 0 positive
  utils::Fraction f4{1836454, 9289927};
  REQUIRE((uint8_t{0} <= f4) == true);
  // 0 negative
  utils::Fraction f5{-7712865, 1328312};
  REQUIRE((uint8_t{0} <= f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint8_t{0} <= f6) == true);
...
TEST_CASE("fraction less than equal to uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{191, 1};
  REQUIRE((f0 <= uint8_t{191}) == true);
  // positive positive not equal
  utils::Fraction f1{5977774, 3498795};
  REQUIRE((f1 <= uint8_t{197}) == true);
  // positive 0
  utils::Fraction f2{8215127, 4459119};
  REQUIRE((f2 <= uint8_t{0}) == false);
  // negative positive
  utils::Fraction f3{-1284319, 5008016};
  REQUIRE((f3 <= uint8_t{87}) == true);
  // negative 0
  utils::Fraction f4{-1122035, 250958};
  REQUIRE((f4 <= uint8_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int16_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{32134, 1};
  REQUIRE((int16_t{32134} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{701257, 1256417};
  REQUIRE((int16_t{16460} <= f1) == false);
  // positive negative
  utils::Fraction f2{-3688040, 1580231};
  REQUIRE((int16_t{29139} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int16_t{18478} <= f3) == false);
  // negative positive
  utils::Fraction f4{1000613, 148339};
  REQUIRE((int16_t{-15655} <= f4) == true);
  // negative negative equal
  utils::Fraction f5{-18673, 1};
  REQUIRE((int16_t{-18673} <= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-451331, 7082284};
  REQUIRE((int16_t{-13513} <= f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int16_t{-26060} <= f7) == true);
  // 0 positive
  utils::Fraction f8{3364967, 9940395};
  REQUIRE((int16_t{0} <= f8) == true);
  // 0 negative
  utils::Fraction f9{-220861, 363390};
  REQUIRE((int16_t{0} <= f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int16_t{0} <= f10) == true);
...
TEST_CASE("fraction less than equal to int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{15702, 1};
  REQUIRE((f0 <= int16_t{15702}) == true);
  // positive positive not equal
  utils::Fraction f1{5163833, 2334449};
  REQUIRE((f1 <= int16_t{10082}) == true);
  // positive negative
  utils::Fraction f2{9886957, 4777613};
  REQUIRE((f2 <= int16_t{-3932}) == false);
  // positive 0
  utils::Fraction f3{383417, 7276};
  REQUIRE((f3 <= int16_t{0}) == false);
  // negative positive
  utils::Fraction f4{-1869541, 402384};
  REQUIRE((f4 <= int16_t{18024}) == true);
  // negative negative equal
  utils::Fraction f5{-23788, 1};
  REQUIRE((f5 <= int16_t{-23788}) == true);
  // negative negative not equal
  utils::Fraction f6{-4664747, 799918};
  REQUIRE((f6 <= int16_t{-6292}) == false);
  // negative 0
  utils::Fraction f7{-310006, 4029011};
  REQUIRE((f7 <= int16_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint16_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{49616, 1};
  REQUIRE((uint16_t{49616} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{1911577, 3751989};
  REQUIRE((uint16_t{48898} <= f1) == false);
  // positive negative
  utils::Fraction f2{-9022659, 7495741};
  REQUIRE((uint16_t{39122} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{51058} <= f3) == false);
  // 0 positive
  utils::Fraction f4{2058959, 646855};
  REQUIRE((uint16_t{0} <= f4) == true);
  // 0 negative
  utils::Fraction f5{-1041749, 3842350};
  REQUIRE((uint16_t{0} <= f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint16_t{0} <= f6) == true);
...
TEST_CASE("fraction less than equal to uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{32218, 1};
  REQUIRE((f0 <= uint16_t{32218}) == true);
  // positive positive not equal
  utils::Fraction f1{790137, 996652};
  REQUIRE((f1 <= uint16_t{63922}) == true);
  // positive 0
  utils::Fraction f2{123869, 79316};
  REQUIRE((f2 <= uint16_t{0}) == false);
  // negative positive
  utils::Fraction f3{-93197, 360310};
  REQUIRE((f3 <= uint16_t{16802}) == true);
  // negative 0
  utils::Fraction f4{-4101267, 3221545};
  REQUIRE((f4 <= uint16_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int32_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{657540, 1};
  REQUIRE((int32_t{657540} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{6831335, 3137562};
  REQUIRE((int32_t{2691365} <= f1) == false);
  // positive negative
  utils::Fraction f2{-908297, 1094836};
  REQUIRE((int32_t{3134328} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int32_t{9113019} <= f3) == false);
  // negative positive
  utils::Fraction f4{2723318, 5157619};
  REQUIRE((int32_t{-7241392} <= f4) == true);
  // negative negative equal
  utils::Fraction f5{-4460436, 1};
  REQUIRE((int32_t{-4460436} <= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-4785142, 6046209};
  REQUIRE((int32_t{-52712} <= f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int32_t{-6546250} <= f7) == true);
  // 0 positive
  utils::Fraction f8{8528517, 2604674};
  REQUIRE((int32_t{0} <= f8) == true);
  // 0 negative
  utils::Fraction f9{-2157990, 479711};
  REQUIRE((int32_t{0} <= f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int32_t{0} <= f10) == true);
...
TEST_CASE("fraction less than equal to int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{58114, 1};
  REQUIRE((f0 <= int32_t{58114}) == true);
  // positive positive not equal
  utils::Fraction f1{4683217, 1828621};
  REQUIRE((f1 <= int32_t{9369050}) == true);
  // positive negative
  utils::Fraction f2{8956553, 2027689};
  REQUIRE((f2 <= int32_t{-6048959}) == false);
  // positive 0
  utils::Fraction f3{1126321, 7822768};
  REQUIRE((f3 <= int32_t{0}) == false);
  // negative positive
  utils::Fraction f4{-2674133, 3136979};
  REQUIRE((f4 <= int32_t{1044544}) == true);
  // negative negative equal
  utils::Fraction f5{-2476009, 1};
  REQUIRE((f5 <= int32_t{-2476009}) == true);
  // negative negative not equal
  utils::Fraction f6{-4105775, 4567061};
  REQUIRE((f6 <= int32_t{-6512594}) == false);
  // negative 0
  utils::Fraction f7{-3844993, 4844885};
  REQUIRE((f7 <= int32_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint32_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6673212, 1};
  REQUIRE((uint32_t{6673212} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{4919755, 2433223};
  REQUIRE((uint32_t{2198123} <= f1) == false);
  // positive negative
  utils::Fraction f2{-760403, 2218642};
  REQUIRE((uint32_t{1148130} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{6748571} <= f3) == false);
  // 0 positive
  utils::Fraction f4{5267521, 4025828};
  REQUIRE((uint32_t{0} <= f4) == true);
  // 0 negative
  utils::Fraction f5{-8728712, 9143315};
  REQUIRE((uint32_t{0} <= f5) == false);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint32_t{0} <= f6) == true);
...
TEST_CASE("fraction less than equal to uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1873376, 1};
  REQUIRE((f0 <= uint32_t{1873376}) == true);
  // positive positive not equal
  utils::Fraction f1{965213, 9158465};
  REQUIRE((f1 <= uint32_t{2445400}) == true);
  // positive 0
  utils::Fraction f2{2662403, 848015};
  REQUIRE((f2 <= uint32_t{0}) == false);
  // negative positive
  utils::Fraction f3{-1452901, 7692229};
  REQUIRE((f3 <= uint32_t{7182084}) == true);
  // negative 0
  utils::Fraction f4{-1324798, 1459379};
  REQUIRE((f4 <= uint32_t{0}) == true);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int64_t fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{1251116, 1};
  REQUIRE((int64_t{1251116} <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{5383733, 6939045};
  REQUIRE((int64_t{9447009} <= f1) == false);
  // positive negative
  utils::Fraction f2{-8089643, 361287};
  REQUIRE((int64_t{6613016} <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int64_t{8899070} <= f3) == false);
  // negative positive
  utils::Fraction f4{4544540, 3190287};
  REQUIRE((int64_t{-5106454} <= f4) == true);
  // negative negative equal
  utils::Fraction f5{-8516547, 1};
  REQUIRE((int64_t{-8516547} <= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-8679651, 8434156};
  REQUIRE((int64_t{-9156321} <= f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int64_t{-6138203} <= f7) == true);
  // 0 positive
  utils::Fraction f8{5235396, 3880445};
  REQUIRE((int64_t{0} <= f8) == true);
  // 0 negative
  utils::Fraction f9{-1987401, 1233016};
  REQUIRE((int64_t{0} <= f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int64_t{0} <= f10) == true);
...
TEST_CASE("fraction less than equal to int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{7979223, 1};
  REQUIRE((f0 <= int64_t{7979223}) == true);
  // positive positive not equal
  utils::Fraction f1{745803, 8633233};
  REQUIRE((f1 <= int64_t{8348339}) == true);
  // positive negative
  utils::Fraction f2{8465758, 5239777};
  REQUIRE((f2 <= int64_t{-2876179}) == false);
  // positive 0
  utils::Fraction f3{830607, 384718};
  REQUIRE((f3 <= int64_t{0}) == false);
  // negative positive
  utils::Fraction f4{-1210283, 1051837};
  REQUIRE((f4 <= int64_t{7511176}) == true);
  // negative negative equal
  utils::Fraction f5{-45239, 1};
  REQUIRE((f5 <= int64_t{-45239}) == true);
  // negative negative not equal
  utils::Fraction f6{-8236309, 9929903};
  REQUIRE((f6 <= int64_t{-8097962}) == false);
  // negative 0
  utils::Fraction f7{-5136128, 5517161};
  REQUIRE((f7 <= int64_t{0}) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("double fraction less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{7358425574038373, 1073741824};
  REQUIRE((6853067.850729798 <= f0) == true);
  // positive positive not equal
  utils::Fraction f1{7198154, 9215031};
  REQUIRE((2559902.1994168344 <= f1) == false);
  // positive negative
  utils::Fraction f2{-3839885, 6077066};
  REQUIRE((944508.2688977061 <= f2) == false);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((6878227.530138672 <= f3) == false);
  // negative positive
  utils::Fraction f4{271120, 66527};
  REQUIRE((-3346593.035167956 <= f4) == true);
  // negative negative equal
  utils::Fraction f5{-5127499893230001, 536870912};
  REQUIRE((-9550712.803807111 <= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-4193743, 6856805};
  REQUIRE((-5596053.042530582 <= f6) == true);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((-6659755.483018812 <= f7) == true);
  // 0 positive
  utils::Fraction f8{7558449, 7319999};
  REQUIRE((0.0 <= f8) == true);
  // 0 negative
  utils::Fraction f9{-3698465, 7607424};
  REQUIRE((0.0 <= f9) == false);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((0.0 <= f10) == true);
...
TEST_CASE("fraction double less than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4566614974472407, 536870912};
  REQUIRE((f0 <= 8505983.23060648) == true);
  // positive positive not equal
  utils::Fraction f1{1432074, 1158713};
  REQUIRE((f1 <= 5594920.075434088) == true);
  // positive negative
  utils::Fraction f2{368141, 71240};
  REQUIRE((f2 <= -4791157.179966361) == false);
  // positive 0
  utils::Fraction f3{7104, 400777};
  REQUIRE((f3 <= 0.0) == false);
  // negative positive
  utils::Fraction f4{-6389607, 8641543};
  REQUIRE((f4 <= 6351056.052238692) == true);
  // negative negative equal
  utils::Fraction f5{-8408403464740445, 1073741824};
  REQUIRE((f5 <= -7830935.963187781) == true);
  // negative negative not equal
  utils::Fraction f6{-2949875, 6986311};
  REQUIRE((f6 <= -6595182.953199975) == false);
  // negative 0
  utils::Fraction f7{-9919808, 244071};
  REQUIRE((f7 <= 0.0) == true);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("fraction fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{9321494, 9105791};
  utils::Fraction f1{9321494, 9105791};
  REQUIRE((f0 >= f1) == true);
  // positive positive not equal
  utils::Fraction f2{5278897, 887625};
  utils::Fraction f3{4762152, 1749781};
  REQUIRE((f2 >= f3) == true);
  // positive negative
  utils::Fraction f4{1179763, 2377213};
  utils::Fraction f5{-299251, 562466};
  REQUIRE((f4 >= f5) == true);
  // positive 0
  utils::Fraction f6{348389, 6265691};
  utils::Fraction f7{0, 1};
  REQUIRE((f6 >= f7) == true);
  // negative positive
  utils::Fraction f8{-7106420, 859979};
  utils::Fraction f9{12537, 3191521};
  REQUIRE((f8 >= f9) == false);
  // negative negative equal
  utils::Fraction f10{-7226069, 2733045};
  utils::Fraction f11{-7226069, 2733045};
  REQUIRE((f10 >= f11) == true);
  // negative negative not equal
  utils::Fraction f12{-4016409, 2980699};
  utils::Fraction f13{-9636398, 5567961};
  REQUIRE((f12 >= f13) == true);
  // negative 0
  utils::Fraction f14{-2993582, 2543413};
  utils::Fraction f15{0, 1};
  REQUIRE((f14 >= f15) == false);
  // 0 positive
  utils::Fraction f16{0, 1};
  utils::Fraction f17{8382071, 5220099};
  REQUIRE((f16 >= f17) == false);
  // 0 negative
  utils::Fraction f18{0, 1};
  utils::Fraction f19{-4920697, 8102403};
  REQUIRE((f18 >= f19) == true);
  // 0 0
  utils::Fraction f20{0, 1};
  utils::Fraction f21{0, 1};
...
TEST_CASE("int8_t fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4, 1};
  REQUIRE((int8_t{4} >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{9867403, 9204480};
  REQUIRE((int8_t{14} >= f1) == true);
  // positive negative
  utils::Fraction f2{-1756131, 3359245};
  REQUIRE((int8_t{99} >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int8_t{94} >= f3) == true);
  // negative positive
  utils::Fraction f4{5546245, 5011737};
  REQUIRE((int8_t{-74} >= f4) == false);
  // negative negative equal
  utils::Fraction f5{-63, 1};
  REQUIRE((int8_t{-63} >= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-1008265, 7781802};
  REQUIRE((int8_t{-83} >= f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int8_t{-6} >= f7) == false);
  // 0 positive
  utils::Fraction f8{4197143, 984318};
  REQUIRE((int8_t{0} >= f8) == false);
  // 0 negative
  utils::Fraction f9{-4427187, 1023283};
  REQUIRE((int8_t{0} >= f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int8_t{0} >= f10) == true);
...
TEST_CASE("fraction greater than equal to int8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{28, 1};
  REQUIRE((f0 >= int8_t{28}) == true);
  // positive positive not equal
  utils::Fraction f1{4562891, 4149428};
  REQUIRE((f1 >= int8_t{42}) == false);
  // positive negative
  utils::Fraction f2{199961, 3040388};
  REQUIRE((f2 >= int8_t{-72}) == true);
  // positive 0
  utils::Fraction f3{472987, 211928};
  REQUIRE((f3 >= int8_t{0}) == true);
  // negative positive
  utils::Fraction f4{-1097209, 2834683};
  REQUIRE((f4 >= int8_t{90}) == false);
  // negative negative equal
  utils::Fraction f5{-70, 1};
  REQUIRE((f5 >= int8_t{-70}) == true);
  // negative negative not equal
  utils::Fraction f6{-228245, 993884};
  REQUIRE((f6 >= int8_t{-118}) == true);
  // negative 0
  utils::Fraction f7{-3239858, 2202999};
  REQUIRE((f7 >= int8_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint8_t fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{104, 1};
  REQUIRE((uint8_t{104} >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{375339, 165644};
  REQUIRE((uint8_t{220} >= f1) == true);
  // positive negative
  utils::Fraction f2{-4737589, 9836089};
  REQUIRE((uint8_t{184} >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint8_t{84} >= f3) == true);
  // 0 positive
  utils::Fraction f4{5526674, 9089585};
  REQUIRE((uint8_t{0} >= f4) == false);
  // 0 negative
  utils::Fraction f5{-428090, 4331559};
  REQUIRE((uint8_t{0} >= f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint8_t{0} >= f6) == true);
...
TEST_CASE("fraction greater than equal to uint8_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{141, 1};
  REQUIRE((f0 >= uint8_t{141}) == true);
  // positive positive not equal
  utils::Fraction f1{1753889, 4288441};
  REQUIRE((f1 >= uint8_t{69}) == false);
  // positive 0
  utils::Fraction f2{1529314, 231255};
  REQUIRE((f2 >= uint8_t{0}) == true);
  // negative positive
  utils::Fraction f3{-1472707, 1454375};
  REQUIRE((f3 >= uint8_t{208}) == false);
  // negative 0
  utils::Fraction f4{-2933837, 1471451};
  REQUIRE((f4 >= uint8_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("int16_t fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{17607, 1};
  REQUIRE((int16_t{17607} >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{9223603, 7758000};
  REQUIRE((int16_t{25296} >= f1) == true);
  // positive negative
  utils::Fraction f2{-2528992, 2081921};
  REQUIRE((int16_t{11212} >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((int16_t{14904} >= f3) == true);
  // negative positive
  utils::Fraction f4{940091, 4698363};
  REQUIRE((int16_t{-2774} >= f4) == false);
  // negative negative equal
  utils::Fraction f5{-27902, 1};
  REQUIRE((int16_t{-27902} >= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-430669, 9512976};
  REQUIRE((int16_t{-15369} >= f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((int16_t{-9768} >= f7) == false);
  // 0 positive
  utils::Fraction f8{2645493, 7692560};
  REQUIRE((int16_t{0} >= f8) == false);
  // 0 negative
  utils::Fraction f9{-4092649, 4089062};
  REQUIRE((int16_t{0} >= f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((int16_t{0} >= f10) == true);
...
TEST_CASE("fraction greater than equal to int16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{24941, 1};
  REQUIRE((f0 >= int16_t{24941}) == true);
  // positive positive not equal
  utils::Fraction f1{701799, 309161};
  REQUIRE((f1 >= int16_t{6759}) == false);
  // positive negative
  utils::Fraction f2{6571208, 386311};
  REQUIRE((f2 >= int16_t{-24834}) == true);
  // positive 0
  utils::Fraction f3{379319, 881942};
  REQUIRE((f3 >= int16_t{0}) == true);
  // negative positive
  utils::Fraction f4{-9451279, 8349344};
  REQUIRE((f4 >= int16_t{27798}) == false);
  // negative negative equal
  utils::Fraction f5{-5676, 1};
  REQUIRE((f5 >= int16_t{-5676}) == true);
  // negative negative not equal
  utils::Fraction f6{-195076, 56333};
  REQUIRE((f6 >= int16_t{-26230}) == true);
  // negative 0
  utils::Fraction f7{-2018773, 7013920};
  REQUIRE((f7 >= int16_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint16_t fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{9861, 1};
  REQUIRE((uint16_t{9861} >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{2950910, 7456153};
  REQUIRE((uint16_t{62214} >= f1) == true);
  // positive negative
  utils::Fraction f2{-2192074, 1855935};
  REQUIRE((uint16_t{1504} >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint16_t{53029} >= f3) == true);
  // 0 positive
  utils::Fraction f4{5000057, 8398691};
  REQUIRE((uint16_t{0} >= f4) == false);
  // 0 negative
  utils::Fraction f5{-869789, 98372};
  REQUIRE((uint16_t{0} >= f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint16_t{0} >= f6) == true);
...
TEST_CASE("fraction greater than equal to uint16_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{22163, 1};
  REQUIRE((f0 >= uint16_t{22163}) == true);
  // positive positive not equal
  utils::Fraction f1{8774597, 6318865};
  REQUIRE((f1 >= uint16_t{51256}) == false);
  // positive 0
  utils::Fraction f2{5811784, 3854685};
  REQUIRE((f2 >= uint16_t{0}) == true);
  // negative positive
  utils::Fraction f3{-3305458, 329161};
  REQUIRE((f3 >= uint16_t{2239}) == false);
  // negative 0
  utils::Fraction f4{-9768733, 1755230};
  REQUIRE((f4 >= uint16_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction greater than equal to int32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{6833539, 1};
  REQUIRE((f0 >= int32_t{6833539}) == true);
  // positive positive not equal
  utils::Fraction f1{2563221, 870490};
  REQUIRE((f1 >= int32_t{3830405}) == false);
  // positive negative
  utils::Fraction f2{6345677, 9204586};
  REQUIRE((f2 >= int32_t{-9641324}) == true);
  // positive 0
  utils::Fraction f3{1584616, 9930875};
  REQUIRE((f3 >= int32_t{0}) == true);
  // negative positive
  utils::Fraction f4{-3425729, 7800853};
  REQUIRE((f4 >= int32_t{6485552}) == false);
  // negative negative equal
  utils::Fraction f5{-4117691, 1};
  REQUIRE((f5 >= int32_t{-4117691}) == true);
  // negative negative not equal
  utils::Fraction f6{-4013179, 5053595};
  REQUIRE((f6 >= int32_t{-3228696}) == true);
  // negative 0
  utils::Fraction f7{-2004085, 85794};
  REQUIRE((f7 >= int32_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("uint32_t fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{4907563, 1};
  REQUIRE((uint32_t{4907563} >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{941733, 1595306};
  REQUIRE((uint32_t{3370347} >= f1) == true);
  // positive negative
  utils::Fraction f2{-1169601, 8465302};
  REQUIRE((uint32_t{8534811} >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((uint32_t{4108148} >= f3) == true);
  // 0 positive
  utils::Fraction f4{6070311, 6726274};
  REQUIRE((uint32_t{0} >= f4) == false);
  // 0 negative
  utils::Fraction f5{-763689, 4987940};
  REQUIRE((uint32_t{0} >= f5) == true);
  // 0 0
  utils::Fraction f6{0, 1};
  REQUIRE((uint32_t{0} >= f6) == true);
...
TEST_CASE("fraction greater than equal to uint32_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{8028078, 1};
  REQUIRE((f0 >= uint32_t{8028078}) == true);
  // positive positive not equal
  utils::Fraction f1{267707, 310613};
  REQUIRE((f1 >= uint32_t{2403591}) == false);
  // positive 0
  utils::Fraction f2{9718873, 7525113};
  REQUIRE((f2 >= uint32_t{0}) == true);
  // negative positive
  utils::Fraction f3{-3163843, 2512275};
  REQUIRE((f3 >= uint32_t{8989168}) == false);
  // negative 0
  utils::Fraction f4{-6998190, 1633241};
  REQUIRE((f4 >= uint32_t{0}) == false);
  // 0 positive
  utils::Fraction f5{0, 1};
...
TEST_CASE("fraction greater than equal to int64_t", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{2534212, 1};
  REQUIRE((f0 >= int64_t{2534212}) == true);
  // positive positive not equal
  utils::Fraction f1{356939, 957692};
  REQUIRE((f1 >= int64_t{4880885}) == false);
  // positive negative
  utils::Fraction f2{6443865, 9468706};
  REQUIRE((f2 >= int64_t{-2728939}) == true);
  // positive 0
  utils::Fraction f3{801796, 3865927};
  REQUIRE((f3 >= int64_t{0}) == true);
  // negative positive
  utils::Fraction f4{-941195, 479207};
  REQUIRE((f4 >= int64_t{1575835}) == false);
  // negative negative equal
  utils::Fraction f5{-527614, 1};
  REQUIRE((f5 >= int64_t{-527614}) == true);
  // negative negative not equal
  utils::Fraction f6{-1410439, 548299};
  REQUIRE((f6 >= int64_t{-5108907}) == true);
  // negative 0
  utils::Fraction f7{-295159, 3207658};
  REQUIRE((f7 >= int64_t{0}) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("double fraction greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{3473482516254713, 2147483648};
  REQUIRE((1617466.339960095 >= f0) == true);
  // positive positive not equal
  utils::Fraction f1{5653882, 9017863};
  REQUIRE((7237395.605435523 >= f1) == true);
  // positive negative
  utils::Fraction f2{-8127181, 9997456};
  REQUIRE((9992184.546403065 >= f2) == true);
  // positive 0
  utils::Fraction f3{0, 1};
  REQUIRE((4929100.53539204 >= f3) == true);
  // negative positive
  utils::Fraction f4{8309108, 3680587};
  REQUIRE((-7565267.031707894 >= f4) == false);
  // negative negative equal
  utils::Fraction f5{-1848641185087115, 268435456};
  REQUIRE((-6886725.072142165 >= f5) == true);
  // negative negative not equal
  utils::Fraction f6{-5731079, 1533330};
  REQUIRE((-3836358.1900747963 >= f6) == false);
  // negative 0
  utils::Fraction f7{0, 1};
  REQUIRE((-9883320.522670005 >= f7) == false);
  // 0 positive
  utils::Fraction f8{1686761, 8335551};
  REQUIRE((0.0 >= f8) == false);
  // 0 negative
  utils::Fraction f9{-4099067, 3046124};
  REQUIRE((0.0 >= f9) == true);
  // 0 0
  utils::Fraction f10{0, 1};
  REQUIRE((0.0 >= f10) == true);
...
TEST_CASE("fraction double greater than equal to", "[utils][fraction]") {
  // positive positive equal
  utils::Fraction f0{2861299648405027, 536870912};
  REQUIRE((f0 >= 5329585.910597866) == true);
  // positive positive not equal
  utils::Fraction f1{3374957, 3050789};
  REQUIRE((f1 >= 6862425.80559151) == false);
  // positive negative
  utils::Fraction f2{1921954, 6411295};
  REQUIRE((f2 >= -7246612.57464124) == true);
  // positive 0
  utils::Fraction f3{21738, 413381};
  REQUIRE((f3 >= 0.0) == true);
  // negative positive
  utils::Fraction f4{-3515396, 4672423};
  REQUIRE((f4 >= 7820810.861228255) == false);
  // negative negative equal
  utils::Fraction f5{-2085483905792353, 2147483648};
  REQUIRE((f5 >= -971129.1202308391) == true);
  // negative negative not equal
  utils::Fraction f6{-6557635, 2620244};
  REQUIRE((f6 >= -1261455.3147162215) == true);
  // negative 0
  utils::Fraction f7{-1746047, 8008616};
  REQUIRE((f7 >= 0.0) == false);
  // 0 positive
  utils::Fraction f8{0, 1};
...
TEST_CASE("int8_t conversion", "[utils][fraction]") {
  // positive
  utils::Fraction f0{55, 37};
  REQUIRE(static_cast<int8_t>(f0) == 1);
  // negative
  utils::Fraction f1{-30, 7};
...
TEST_CASE("int32_t conversion", "[utils][fraction]") {
  // positive
  utils::Fraction f0{4649679, 2509195};
  REQUIRE(static_cast<int32_t>(f0) == 1);
  // negative
  utils::Fraction f1{-3101001, 938012};
...
TEST_CASE("uint32_t conversion", "[utils][fraction]") {
  // positive
  utils::Fraction f0{9398404, 1261649};
...
TEST_CASE("int64_t conversion", "[utils][fraction]") {
  // positive
  utils::Fraction f0{5429729, 5477161};
  REQUIRE(static_cast<int64_t>(f0) == 0);
  // negative
  utils::Fraction f1{-1236355, 1353767};
